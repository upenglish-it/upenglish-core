...
!(function () {
    ...
    is = (e, t = 4, n = !0, o = !0) => {
      const r = ((e, t) => (t <= 0 ? "" : new Array(t + 1).join(" ")))(0, t),
        ...
        a = X(
          s,
          (e, t) =>
            ((e) => -1 !== " \f\t\v".indexOf(e))(t) || t === ur
              ? e.pcIsSpace || ("" === e.str && n) || (e.str.length === s.length - 1 && o) || ((e, t) => t < e.length && t >= 0 && as(e[t]))(s, e.str.length + 1)
                ? { pcIsSpace: !1, str: e.str + ur }
                : { pcIsSpace: !0, str: e.str + " " }
              : { pcIsSpace: as(t), str: e.str + t },
          { pcIsSpace: !1, str: "" }
        );
      return a.str;
    },
  ...
  const ms = (e, t = !0) =>
    ...
    ps = (e, t) =>
      C(t.querySelector(e))
        ? (t.setAttribute(fs, "true"), "inline-boundary" === t.getAttribute("data-mce-selected") && t.removeAttribute("data-mce-selected"), !0)
        : (t.removeAttribute(fs), !1),
    hs = (e, t) => {
    ...
    bs = (e, t) => {
      ...
      for (let t = e[o]; t; t = t[o]) if (ms(bn(t))) return void (null === (n = t.parentNode) || void 0 === n || n.removeChild(t));
    },
    vs = (e, t, n) => {
    ...
    ys = (e, t) => {
      ...
      vs(e, t, n),
        ((e, t, n) => {
          q([...n, ...(Es(e, t) ? [t] : [])], (t) =>
            q(Mo(bn(t), t.nodeName.toLowerCase()), (t) => {
              Ss(e, t.dom) && Co(t);
            })
          );
        })(e, t, n);
    ...
    Ws = (e, t) =>
      e.replace(t ? Ms : Is, (e) => (e.length > 1 ? "&#" + (1024 * (e.charCodeAt(0) - 55296) + (e.charCodeAt(1) - 56320) + 65536) + ";" : js[e] || "&#" + e.charCodeAt(0) + ";")),
    Ks = (e, t, n) => {
      const o = n || Vs;
      ...
      const s = {},
        ...
        d = ((e) => {
          ...
          const a = (e, o = "", r = "") => {
              ...
              for (; i--; ) {
                const e = oa([n, o].join(" "));
                t[a[i]] = { attributes: se(e, () => ({})), attributesOrder: e, children: se(s, N(Qs)) };
              }
            },
            i = (e, n) => {
              const o = oa(e),
        ...
        parse: (t) => {
          ...
          const l = e.url_converter,
            ...
            u = (e, t, n) => {
              ...
              for (; d-- && l[d] === l[d + 1]; );
              (d > -1 && n) ||
                ((a[e + t] = -1 === d ? l[0] : l.join(" ")), delete a[e + "-top" + t], delete a[e + "-right" + t], delete a[e + "-bottom" + t], delete a[e + "-left" + t]);
            },
            m = (e) => {
              const t = a[e];
              if (!t) return;
    ...
    da = { keyLocation: !0, layerX: !0, layerY: !0, returnValue: !0, webkitMovementX: !0, webkitMovementY: !0, keyIdentifier: !0, mozPressure: !0 },
    ca = (e, t) => {
      const n = null != t ? t : {};
          ...
          r.domLoaded && "ready" === t && "complete" === e.readyState
            ...
            : (r.hasFocusIn ||
              ...
              s
                ...
                : ((r.events[l][t] = s = [{ func: n, scope: o }]), (s.fakeName = f), (s.capture = m), (s.nativeHandler = u), "ready" === t ? ha(e, u, r) : fa(e, f || t, u, m)));
      }
      return (e = s = null), n;
    }
    unbind(e, t, n) {
  ...
  const va = Dt.each,
    ...
    Na = (e, t = {}) => {
      const n = {},
        ...
        r = {};
      let s = 0;
      const a = Ts.forElement(bn(e), { contentCssCors: t.contentCssCors, referrerPolicy: t.referrerPolicy }),
        i = [],
        l = t.schema ? t.schema : ia({}),
        d = la({ url_converter: t.url_converter, url_converter_scope: t.url_converter_scope }, t.schema),
          ...
          T(e, (e) => {
            if (jo(e)) {
              const r = bn(e),
                ...
                a = Jt(r, n),
                i = Y[n];
              i && i.set ? i.set(r.dom, s, n) : xa(r, n, s), a !== s && t.onSetAttrib && t.onSetAttrib({ attrElm: r.dom, attrName: n, attrValue: s });
            }
          });
        },
        ...
        G = {
          ...
          dumpRng: (e) =>
            "startContainer: " + e.startContainer.nodeName + ", startOffset: " + e.startOffset + ", endContainer: " + e.endContainer.nodeName + ", endOffset: " + e.endOffset,
        },
        Y = ((e, t, n) => {
  ...
  const Ja = (e) => {
    ...
    ni = (e, t, n = L) => {
      ...
      return { current: () => I.from(o.current()).filter(Xo), next: () => r("next"), prev: () => r("prev"), prev2: () => r("prev2") };
    },
    oi = (e, t) => {
    ...
    si = (e) =>
      e
        ? { left: ri(e.left), top: ri(e.top), bottom: ri(e.bottom), right: ri(e.right), width: ri(e.width), height: ri(e.height) }
    ...
    Oi = (e) => {
      ...
      return (
        (n = o.length > 0 ? si(o[0]) : si(e.getBoundingClientRect())),
        !Ni(e) && xi(e) && Ai(n)
          ? ((e) => {
          ...
          (n = ((e) => {
            const t = [],
              n = (e) => {
                var n, o;
                0 !== e.height &&
                  ((t.length > 0 && ((n = e), (o = t[t.length - 1]), n.left === o.left && n.top === o.top && n.bottom === o.bottom && n.right === o.right)) || t.push(e));
              },
              o = (e, t) => {
  ...
  const Di = (e, t) => {
    ...
    zi = (e) => (t) => e === t,
    ji = (e) =>
      (Li(e) ? "text()" : e.nodeName.toLowerCase()) +
      "[" +
      ((e) => {
        let t, n;
    ...
    Hi = (e, t) => {
      ...
      if (Li(r))
        n = ((e, t) => {
          let n = e;
          for (; (n = n.previousSibling) && Li(n); ) t += n.data.length;
          return t;
        })(r, s);
      else {
    ...
    Xi = (e, t, n) => {
      ...
      return ((e, t, n, o) => {
        ...
        return t.isCollapsed() ? { start: s, forward: a, ...i } : { start: s, end: qi(r, e, n, o, !1), forward: a, ...i };
      })(e, n, t, r);
    },
    Qi = (e, t, n) => {
    ...
    Ji = (e, t) => {
      ...
      const r = n.uniqueId(),
        ...
        i = a.nodeName,
        l = e.isForward();
      if ("IMG" === i) return { name: i, index: Wi(n, i, a) };
      ...
      return Pi(n, o, c), e.moveToBookmark({ id: r, keep: !0, forward: l }), { id: r, forward: l };
    },
    Zi = O(Xi, R, !0),
    el = (e) => {
      const t = (t) => t(e),
    ...
    nl = { value: el, error: tl, fromOption: (e, t) => e.fold(() => tl(t), el) },
    ol = (e) => {
  ...
  ol([{ bothErrors: ["error1", "error2"] }, { firstError: ["error1", "value2"] }, { secondError: ["value1", "error2"] }, { bothValues: ["value1", "value2"] }]);
  const rl = (e) => "inline-command" === e.type || "inline-format" === e.type,
    sl = (e) => "block-command" === e.type || "block-format" === e.type,
    al = (e) => {
      const t = (t) => nl.error({ message: t, pattern: e }),
        n = (n, o, r) => {
          if (void 0 !== e.format) {
            let r;
            if (p(e.format)) {
      ...
      return void 0 !== e.replacement
        ? m(e.replacement)
          ? 0 === e.start.length
            ...
            : nl.value({ type: "inline-command", start: "", end: e.start, cmd: "mceInsertContent", value: e.replacement })
              ...
              ? ((e, t) => {
                  const n = t.container(),
                    o = ((e, t) => {
                      ...
                      .map((e) => (e < t.offset() ? Bi(n, t.offset() - 1) : t))
                      .getOr(t);
                  return lc(e), o;
                })(e, t)
              : ac(e, t))(e, t),
        ...
        show: (e, c) => {
          ...
          if (!n(c))
            return (
              ...
              pc(a.nextSibling) ? (u.setStart(a, 0), u.setEnd(a, 0)) : (u.setStart(a, 1), u.setEnd(a, 1)),
              u
            );
          {
            const n = ((e, t, n) => {
    ...
    Ac = (e, t, n, o, r) => {
      ...
      if (Nc(t)) {
        ...
        for (; (i = Rc(s.prev.bind(s), r)); ) if (n(i)) return i;
      }
      if (_c(t)) {
        if (a && ((i = Rc(s.next.bind(s), !0)), n(i))) return i;
        for (; (i = Rc(s.next.bind(s), r)); ) if (n(i)) return i;
      }
      return null;
    },
    Oc = (e, t) => {
  ...
  const qc = sr,
    ...
    eu = (e, t, n) => {
      ...
      if (Wc(i)) {
        ...
        if (Nc(e) && l > 0 && ((r = Jc(i, l - 1)), Yc(r)))
          return !Xc(r) && ((s = Ac(r, e, Qc, r)), s) ? (Wc(s) ? Bi(s, s.data.length) : Bi.after(s)) : Wc(r) ? Bi(r, r.data.length) : Bi.before(r);
        if (_c(e) && l < i.childNodes.length && ((r = Jc(i, l)), Yc(r)))
          return Gc(r)
            ? ((e, t) => {
                const n = t.nextSibling;
                return n && Yc(n) ? (Wc(n) ? Bi(n, 0) : Bi.before(n)) : eu(Vc.Forwards, Bi.after(t), e);
              })(n, r)
            : !Xc(r) && ((s = Ac(r, e, Qc, r)), s)
              ? Wc(s)
                ? Bi(s, 0)
                : Bi.before(s)
              : Wc(r)
    ...
    tu = (e) => ({ next: (t) => eu(Vc.Forwards, t, e), prev: (t) => eu(Vc.Backwards, t, e) }),
    ...
    lu = (e, t) => {
      ...
      return Xo(n)
        ? I.some(Bi(n, e ? 0 : n.data.length))
        : n
          ? ts(n)
            ? I.some(e ? Bi.before(n) : nr((o = n)) ? Bi.before(o) : Bi.after(o))
            : ((e, t, n) => {
      ...
      ((e, t, n = !1) =>
        2 === t
          ...
          : 3 === t
            ? ((e) => {
                const t = e.getRng();
                return { start: Hi(e.dom.getRoot(), Bi.fromRangeStart(t)), end: Hi(e.dom.getRoot(), Bi.fromRangeEnd(t)), forward: e.isForward() };
              })(e)
            : t
      ...
      ((e, t) => {
        ...
        if (t) {
          if (bu(t))
            return ((e, t) => {
              const n = e.createRng();
              return xu(e, !0, t, n) && xu(e, !1, t, n) ? I.some({ range: n, forward: vu(t) }) : I.none();
            })(n, t);
          if (((e) => m(e.start))(t))
            return ((e, t) => {
              ...
              return Lt(n, o, (n, o) => {
                const r = e.createRng();
                return r.setStart(n.container(), n.offset()), r.setEnd(o.container(), o.offset()), { range: r, forward: vu(t) };
              });
            })(n, t);
          if (((e) => ke(e, "id"))(t))
            return ((e, t) => {
              ...
              return Lt(n, o.or(n), (n, o) => {
                const r = e.createRng();
                return r.setStart(yu(e, n.container()), n.offset()), r.setEnd(yu(e, o.container()), o.offset()), { range: r, forward: vu(t) };
              });
            })(n, t);
          if (hu(t))
            return ((e, t) =>
          ...
          if (((e) => ke(e, "rng"))(t)) return I.some({ range: t.rng, forward: vu(t) });
        }
        return I.none();
  ...
  const Au = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    Lu = (e, t, n, o) => ({ red: e, green: t, blue: n, alpha: o }),
    Mu = (e, t, n, o) => {
    ...
    em = (e, t, n) => {
      if (e) {
        ...
        for (e = n ? e : e[o]; e; e = e[o]) if (jo(e) || !om(e)) return e;
      }
    },
    ...
    im = (e, t) => {
      if (y(e)) return null;
      {
        let n = String(e);
        return (
          ("color" !== t && "backgroundColor" !== t) || (n = Iu(n)),
    ...
    Em = (e, t, n, o, r, s) => {
      ...
      return l(n, o, xm)
        .bind((e) => (s ? l(e.container, e.offset + (r ? -1 : 0), km) : I.some(e)))
    ...
    _m = (e, t, n, o) => {
      ...
      if ((s && mm(i) && i.wrapper && (s = bm(e, s, "ul,ol").reverse()[0] || s), !s)) for (s = n; s && s[o] && !e.isBlock(s[o]) && ((s = s[o]), !am(s, "br")); );
      return s || n;
    },
    Nm = (e, t, n, o) => {
    ...
    Om = (e, t, n, o = !1) => {
      ...
      const l = n[0];
      return (
        jo(r) && r.hasChildNodes() && ((r = mi(r, s)), Xo(r) && (s = 0)),
        jo(a) && a.hasChildNodes() && ((a = mi(a, t.collapsed ? i : i - 1)), Xo(a) && (i = a.data.length)),
        (r = Cm(e, r)),
        (a = Cm(e, a)),
        Am(r) && ((r = hm(r) ? r : r.parentNode), (r = t.collapsed ? r.previousSibling || r : r.nextSibling || r), Xo(r) && (s = t.collapsed ? r.length : 0)),
        Am(a) && ((a = hm(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), Xo(a) && (i = t.collapsed ? 0 : a.length)),
        t.collapsed &&
          (Em(e, e.getRoot(), r, s, !0, o).each(({ container: e, offset: t }) => {
            (r = e), (s = t);
          }),
          Em(e, e.getRoot(), a, i, !1, o).each(({ container: e, offset: t }) => {
            (a = e), (i = t);
          })),
        (gm(l) || l.block_expand) && ((gm(l) && Xo(r) && 0 !== s) || (r = Rm(e, n, r, s, !0)), (gm(l) && Xo(a) && i !== a.data.length) || (a = Rm(e, n, a, i, !1))),
        pm(l) && ((r = Sm(e, n, t, r, "previousSibling")), (a = Sm(e, n, t, a, "nextSibling"))),
        (mm(l) || fm(l)) &&
          ((r = _m(e, n, r, "previousSibling")), (a = _m(e, n, a, "nextSibling")), mm(l) && (e.isBlock(r) || (r = Rm(e, n, r, s, !0)), e.isBlock(a) || (a = Rm(e, n, a, i, !1)))),
              ...
              e.undoManager.transact(() => {
                ...
                if (
                  (s.collapsed &&
                    !a &&
                    ((e, t) => {
                      const n = Om(e.dom, t, [{ inline: "span" }]);
    ...
    Im = (e) => ({ getBookmark: O(Su, e), moveToBookmark: O(_u, e) });
  ...
  const Fm = (e, t, n) => !n.collapsed && $(n.getClientRects(), (n) => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t)),
    ...
    Vm = (e, t) => e.dispatch("PastePlainTextToggle", { state: t }),
    qm = {
      BACKSPACE: 8,
      DELETE: 46,
      DOWN: 40,
    ...
    Km = Math.abs,
    Gm = Math.round,
    Ym = { nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1] },
    Xm = (e, t) => {
      const n = t.dom,
        o = t.getDoc(),
        r = document,
      ...
      const x = (e) => C(e) && (or(e) || n.is(e, "figure.image")),
        ...
        A = (e) => {
          ...
          (o = e.screenX - u),
            ...
            c && (Km(o) > Km(r) ? ((v = Gm(b * p)), (b = Gm(v / p))) : ((b = Gm(v / p)), (v = Gm(b * p)))),
            R(i, b, v),
            (C = d.startPos.x + o),
            (E = d.startPos.y + r),
            (C = C > 0 ? C : 0),
    ...
    Zm = ol([{ ltr: ["start", "soffset", "finish", "foffset"] }, { rtl: ["start", "soffset", "finish", "foffset"] }]),
  ...
  const tf = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
    nf = document.caretPositionFromPoint
      ? (e, t, n) => {
          var o, r;
      ...
      : document.caretRangeFromPoint
        ...
        : I.none,
    of = ol([{ before: ["element"] }, { on: ["element", "offset"] }, { after: ["element"] }]),
    rf = { before: of.before, on: of.on, after: of.after, cata: (e, t, n, o) => e.fold(t, n, o), getStart: (e) => e.fold(R, R, R) },
    sf = ol([{ domRange: ["rng"] }, { relative: ["startSitu", "finishSitu"] }, { exact: ["start", "soffset", "finish", "foffset"] }]),
    af = {
      ...
      getWin: (e) => {
        const t = ((e) => e.match({ domRange: (e) => bn(e.startContainer), relative: (e, t) => rf.getStart(e), exact: (e, t, n, o) => e }))(e);
        return _n(t);
      },
      range: tf,
    },
      ...
      return ((e, t) => {
        const n = ((e, t) =>
          t.match({
            ...
            relative: (t, n) => ({ ltr: Pe(() => Qm(e, t, n)), rtl: Pe(() => I.some(Qm(e, n, t))) }),
            exact: (t, n, o, r) => ({ ltr: Pe(() => Jm(e, t, n, o, r)), rtl: Pe(() => I.some(Jm(e, o, r, t, n))) }),
          }))(e, t);
        return ((e, t) => {
          const n = t.ltr();
          return n.collapsed
            ? t
                ...
                .map((e) => Zm.rtl(bn(e.endContainer), e.endOffset, bn(e.startContainer), e.startOffset))
                .getOrThunk(() => ef(0, Zm.ltr, n))
            : ef(0, Zm.ltr, n);
        })(0, n);
    ...
    Cf = (e, t, n, o) => {
      ...
      if ((jo(i) && l > i.childNodes.length - 1 && (u = !1), er(i) && ((i = r), (l = 0)), i === r)) {
        ...
        if (i.hasChildNodes()) {
          if (((l = Math.min(!u && l > 0 ? l - 1 : l, i.childNodes.length - 1)), (i = i.childNodes[l]), (l = Xo(i) && d ? i.data.length : 0), !t && i === r.lastChild && Ko(i)))
            return I.none();
          if (
            ((e, t) => {
              let n = t;
  ...
  const Af = (e) => "textarea" === jt(e),
    ...
    Df = (e, t, n, o) => {
      ...
      const a = ((e, t) => {
        const n = ((e, t) => {
            const n = Pn(e);
            if (0 === n.length || Af(e)) return { element: e, offset: t };
            if (t < n.length && !Af(n[t])) return { element: n[t], offset: 0 };
            {
  ...
  const sg = Na.DOM,
      ...
      n.on("focusin", () => {
        ...
        n.on("focusout", () => {
          og.setEditorTimeout(n, () => {
            const t = e.focusedEditor;
            (ag(lg(n)) && t === n) || o(n, un), ig(n, lg(n)) || t !== n || (n.dispatch("blur", { focusedEditor: null }), (e.focusedEditor = null));
          });
        }),
        rg ||
          ((rg = (t) => {
            ...
            n &&
              qn(t).each((t) => {
                ...
                o.ownerDocument === document &&
                  (o === document.body || ig(n, o) || e.focusedEditor !== n || (n.dispatch("blur", { focusedEditor: null }), (e.focusedEditor = null)));
              });
          }),
    ...
    ug = (e, t) => {
      ((e, t) => ((e) => (e.collapsed ? I.from(mi(e.startContainer, e.startOffset)).map(bn) : I.none()))(t).bind((t) => (Er(t) ? I.some(t) : kn(e, t) ? I.none() : I.some(e))))(
        bn(e.getBody()),
        t
      )
        .bind((e) => uu(e.dom))
    ...
    fg = (e) =>
      e.inline
        ...
        : ((e) => C(e.iframeElement) && Wf(bn(e.iframeElement)))(e),
    ...
    wg = (e) => {
      const t = pr(e)
        .filter((e) => 0 !== e.trim().length || e.indexOf(ur) > -1)
        .isSome();
      return (
        t ||
        H(Cg, jt(e)) ||
    ...
    Eg = (e) => Jn(e, xg),
    Sg = { "#text": 3, "#comment": 8, "#cdata": 4, "#pi": 7, "#doctype": 10, "#document-fragment": 11 },
    _g = (e, t, n) => {
  ...
  const Og = (e, t, n = 0) => {
    ...
    Mg = (e, t, n) => {
      ...
      return (
        (o =
          "raw" === t.format
            ? Dt.trim(Dg(e.serializer, n.innerHTML))
            : "text" === t.format
              ? ((e, t) => {
                  const n = e.getDoc(),
                    o = Hn(bn(e.getBody())),
                    r = pn("div", n);
                  Xt(r, "data-mce-bogus", "all"), so(r, { position: "fixed", left: "-9999999px", top: "0" }), ko(r, t.innerHTML), Pg(r), Lg(r);
  ...
  const jg = ["font", "text-decoration", "text-emphasis"],
    ...
    dp = (e, t, n) =>
      ip(e, t.dom, n).forall((e) =>
        lp(t, n).fold(
          () => !Tc(e, n, t.dom),
          (o) => !Tc(e, n, t.dom) && kn(o, bn(e.container()))
        )
      ),
    cp = (e, t, n) =>
      lp(t, n).fold(
        () => ip(e, t.dom, n).forall((e) => !Tc(e, n, t.dom)),
        (t) => ip(e, t.dom, n).isNone()
      ),
    up = O(cp, !1),
    mp = O(cp, !0),
    fp = O(dp, !1),
      ...
      ((e, t, n) =>
        e
          ? ((e, t) =>
              jp(t)
                .orThunk(() => zp(t))
                .orThunk(() => ((e, t) => du(e, Bi.after(t)).orThunk(() => cu(e, Bi.before(t))))(e, t)))(t, n)
          : ((e, t) =>
              zp(t)
                .orThunk(() => jp(t))
                .orThunk(() =>
                  ((e, t) =>
                    I.from(t.previousSibling ? t.previousSibling : t.parentNode)
                      .bind((t) => cu(e, Bi.before(t)))
                      .orThunk(() => du(e, Bi.after(t))))(e, t)
                ))(t, n))(e, t, n).map(O(Up, n)),
    $p = (e, t, n) => {
      n.fold(
        () => {
          e.focus();
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome() ? I.some(l(s.getOrDie(), a.getOrDie(), i.getOrDie())) : I.none()).orThunk(
            () => (n && (o.each((e) => Ip(e.dom, e.dom.length)), r.each((e) => Mp(e.dom, 0))), t)
          )
        );
        var s, a, i, l;
      ...
      return e
        ...
        : Fr(n)
          ? Xo(n.previousSibling)
            ? Bi(n.previousSibling, n.previousSibling.data.length)
            : Bi.before(n)
          : Hr(t)
            ? Bi(n, o - 1)
            : t;
    ...
    mh = (e) => (t) => uh(t, e).map((e) => ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, ah(e))),
    fh = (e, t, n, o) => {
        ...
        const e = dh(n.startContainer, o),
          ...
          r = e
            .bind(
              (
                (e) => (t) =>
                  ju(t, e).bind((e) => de(ah(e)).map((e) => ih(t, e)))
              )(o)
            )
            .bind(mh(o)),
          s = t
            .bind(
              (
                (e) => (t) =>
                  ju(t, e).bind((e) => le(ah(e)).map((e) => ih(e, t)))
              )(o)
            )
            .bind(mh(o));
    ...
    bh = (e, t) => {
      ...
      return ((e, t, n) =>
        ...
        ? o.map((e) => lh.singleCellTable(t, e.start))
        : r.isMultiTable
          ? ((e, t, n, o) =>
              fh(e, t, n, o).bind(({ start: e, end: o }) => {
              ...
              fh(e, t, n, o)
                ...
                .bind((e) => {
                  ...
                  if (r.length > 0) {
                    ...
                    {
                      const e = hh(n, t);
                      return I.some(lh.partialTable(r, I.some({ ...t, rng: e })));
                    }
                  }
                  return I.none();
                }))(o, r, t, n);
    ...
    yh = (e, t, n, o) => {
      ...
      o ? (r.setStart(n.startContainer, n.startOffset), r.setEndAfter(t.dom.lastChild)) : (r.setStartBefore(t.dom.firstChild), r.setEnd(n.endContainer, n.endOffset)),
        kh(e, r, t, !1).each((e) => e());
    },
    Ch = (e) => {
      const t = zu(e),
      ...
      return _h(o, n).fold(
        () =>
          ((e, t, n, o) => {
            ...
            return Sh(n, o).bind((o) =>
              ms(o) ? Nh(e, o) : ((e, t, n, o, r) => au(n, e.getBody(), r).bind((e) => Sh(t, bn(e.getNode())).bind((e) => (xn(e, o) ? I.none() : I.some(E)))))(e, n, t, o, r)
            );
          })(e, t, o, n).orThunk(() =>
            Mt(
              ((e, t) => {
        ...
        (n) =>
          ((e, t, n, o) => {
            ...
            return ms(o)
              ? Nh(e, o)
              : ((e, t, n, o, r) =>
                  au(n, e.getBody(), r).fold(
                    () => I.some(E),
                    (s) =>
                      ((e, t, n, o) =>
                        uu(e.dom)
                          .bind((r) => mu(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r))))
                          .getOr(!0))(o, n, r, s)
                        ? ((e, t) => Nh(e, t))(e, o)
                        : ((e, t, n) =>
                            _h(e, bn(n.getNode())).fold(
                              () => I.some(E),
                              (e) => Mt(!xn(e, t), E)
                            ))(t, o, s)
                  ))(e, n, t, o, r);
      ...
      return e.selection.isCollapsed() && 0 === o.length
        ...
        : ((e, t, n) => {
            ...
            return 0 !== n.length
              ...
              : ((e, t, n, o) =>
                  _h(t, o).fold(
                    () => ((e, t, n) => bh(t, n).bind((t) => t.fold(O(kh, e), O(Eh, e), O(wh, e), O(xh, e))))(e, t, n),
                    (t) => ((e, t) => Nh(e, t))(e, t)
                  ))(e, o, r, t);
          })(e, n, o);
    },
      ...
      return (
        ...
        ((e, t) => {
          ...
          return (
            C(t) &&
            (t.isEmpty(n) ||
              ((e, t) => e.getBlockElements()[t.name] && ((e) => C(e.firstChild) && e.firstChild === e.lastChild)(t) && ((e) => "br" === e.name || e.value === ur)(t.firstChild))(
                e,
                t
              ))
          );
    ...
    Kh = (e) => {
      return e.length > 0 &&
        (!(n = e[e.length - 1]).firstChild || (C(null == (t = n) ? void 0 : t.firstChild) && t.firstChild === t.lastChild && ((e) => e.data === ur || nr(e))(t.firstChild)))
        ? e.slice(0, -1)
        : e;
      var t, n;
    },
    ...
    Xh = (e, t, n, o) => {
      ...
      return s
        ? c(1)
          ...
          : c(2)
            ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), Yh(t[0], n)))(s, a, d, t)
            : ((e, t, n, o) => {
                const r = ((e, t) => {
      ...
      m === f &&
        ...
        s.isCollapsed() ||
          ((e) => {
            ...
            ((e, t, n) => !!C(n) && n === e.getParent(t.endContainer, Jh) && Vu(bn(n), t))(t, n, o)
              ? kh(e, n, bn(o))
              : n.startContainer === n.endContainer && n.endOffset - n.startOffset == 1 && Xo(n.startContainer.childNodes[n.startOffset])
                ? n.deleteContents()
    ...
    db = (e, t, n, o, r, s) => {
      ...
      if (a)
        if (_e(a)) {
          for (let n = 0; n < a.length; n++) if (i ? e.getAttrib(t, a[n]) : lm(e, t, a[n])) return !0;
        } else
          for (const o in a)
            if (ke(a, o)) {
      ...
      if (s && jo(t))
        for (let n = 0; n < s.length; n++) {
          ...
          if (lb(e.dom, t, i) && db(a, t, i, "attributes", r, o) && db(a, t, i, "styles", r, o)) {
            const n = i.classes;
            if (n) for (let r = 0; r < n.length; r++) if (!e.dom.hasClass(t, sm(n[r], o))) return;
            return i;
          }
        }
    },
    ...
    pb = (e) => {
      const t = pn("span");
      return Qt(t, { id: fu, "data-mce-bogus": "1", "data-mce-type": "format-caret" }), e && po(t, hn(mb)), t;
    },
    hb = (e, t, n = !0) => {
      const o = e.dom,
        r = e.selection;
    ...
    bb = (e, t, n = !0) => {
      const o = e.dom,
        r = e.selection;
      if (t) hb(e, t, n);
      else if (!(t = pu(e.getBody(), r.getStart()))) for (; (t = o.get(fu)); ) hb(e, t, !1);
    },
    ...
    wb = (e) => {
      const t = pb(!1),
        n = yb(e, t.dom);
      return { caretContainer: t, caretPosition: Bi(n, 0) };
    },
    xb = (e, t) => {
  ...
  const Nb = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
    ...
    jb = ol([{ keep: [] }, { rename: ["name"] }, { removed: [] }]),
    Hb = /^(src|href|style)$/,
    $b = Dt.each,
    Vb = am,
    ...
    Xb = (e, t, n) => {
      ...
      mm(n) &&
        o === s.getRoot() &&
        ((n.list_block && Vb(t, n.list_block)) ||
          q(ce(t.childNodes), (t) => {
    ...
    Qb = (e, t, n) => (x(e) ? { name: t, value: null } : { name: e, value: sm(t, n) }),
    Jb = (e, t) => {
        ...
        Zb(s, l, t, n, r),
          $b(t.attributes, (e, o) => {
            ...
            if (t.remove_similar || h(i) || !jo(r) || Vb(s.getAttrib(r, a), i)) {
              ...
              if ((Hb.test(a) && l.removeAttribute("data-mce-" + a), "style" === a && $o(["li"])(l) && "none" === s.getStyle(l, "list-style-type")))
    ...
    ov = (e, t, n, o, r) => {
      const s = e.formatter.get(t),
          ...
          return ((e, t, n, o, r, s, a, i) => {
            ...
            if (n) {
              ...
              (a.mixed && m.isBlock(n)) || (o = null !== (l = m.split(n, o)) && void 0 !== l ? l : o),
                c && u && (null === (d = r.parentNode) || void 0 === d || d.insertBefore(c, r), u.appendChild(r), gm(a) && Ib(e, a, 0, c));
            }
            return o;
          })(e, s, i, o, o, 0, a, n);
        },
        ...
        u = (t) => {
          const n = ce(t.childNodes),
            o = c(t) || $(s, (e) => lb(i, t, e)),
            r = t.parentNode;
          if ((!o && C(r) && pm(a) && c(r), a.deep && n.length)) for (let e = 0; e < n.length; e++) u(n[e]);
          q(["underline", "line-through", "overline"], (n) => {
            jo(t) &&
              e.dom.getStyle(t, "text-decoration") === n &&
              t.parentNode &&
              dm(i, t.parentNode) === n &&
              tv(e, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: n } }, void 0, t);
          });
        },
        m = (e) => {
          ...
          if (t) {
            ...
            return (
              ((e) => Nu(e) && jo(e) && ("_start" === e.id || "_end" === e.id))(n) && (n = n[e ? "firstChild" : "lastChild"]),
        ...
        f = (t) => {
          let n,
            o,
            r = Om(i, t, s, t.collapsed);
          if (a.split) {
            if (((r = kf(r)), (n = Wb(e, r, !0)), (o = Wb(e, r)), n !== o)) {
              if (((n = Kb(n, !0)), (o = Kb(o, !1)), qb(i, n, o))) {
                const e = I.from(n.firstChild).getOr(n);
                return d(Yb(i, e, !0, "span", { id: "_start", "data-mce-type": "bookmark" })), void m(!0);
              }
              if (qb(i, o, n)) {
                const e = I.from(o.lastChild).getOr(o);
                return d(Yb(i, e, !1, "span", { id: "_end", "data-mce-type": "bookmark" })), void m(!1);
              }
              (n = Gb(i, n, "span", { id: "_start", "data-mce-type": "bookmark" })), (o = Gb(i, o, "span", { id: "_end", "data-mce-type": "bookmark" }));
              const e = i.createRng();
              e.setStartAfter(n),
                e.setEndBefore(o),
                Tm(i, e, (e) => {
      ...
      if (o) {
        ...
        l.isCollapsed() && gm(a) && !zu(e).length
          ? Cb(e, t, n, r)
          : (Ju(
              e,
              () => Ku(e, f),
          ...
          return (
            sv(
              ...
              (e) =>
                !(
                  !fm(e) ||
                  (("false" !== i.getContentEditable(t) || e.ceFalseOverride) && (!C(e.collapsed) || e.collapsed === a) && i.is(t, e.selector) && !gu(t) && (d(t, e), (n = !0), 1))
                )
            ),
            n
          );
          ...
          a && gm(s) && !zu(e).length
            ? ((e, t, n) => {
                ...
                if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
                  ...
                  let s = o ? gb(o) : null;
                  (o && (null == s ? void 0 : s.data) === mb) || ((c = e.getDoc()), (u = pb(!0).dom), (o = c.importNode(u, !0)), (s = o.firstChild), a.insertNode(o), (i = 1)),
                    e.formatter.apply(t, n, o),
                    r.setCursorLocation(s, i);
                }
                var c, u;
              })(e, t, n)
            : (l.setRng(qh(l.getRng())),
              Ju(
                e,
                () => {
                  Ku(e, (e, t) => {
      ...
      ge(n, (n, r) => {
        const s = (n) => {
          ...
          if (n.state.get() !== a) {
            n.state.set(a);
            const e = s.getOr(t);
            lv(n) ? n.callback(a, { node: e, format: r, parents: o }) : q(n.callbacks, (t) => t(a, { node: e, format: r, parents: o }));
          }
        };
  ...
  let yv = 0;
  const Cv = (e, t, n) =>
      hv(e).bind(({ data: e, type: o, base64Encoded: r }) => {
        ...
        ke = function (e) {
          (Ce && Ce === e) ||
            ...
            ae &&
              ((z = Jv({}, Nv(iy))),
              (H = []),
              !0 === ae.html && (Jv(z, ty), Jv(H, ly)),
              !0 === ae.svg && (Jv(z, ny), Jv(H, dy), Jv(H, uy)),
              !0 === ae.svgFilters && (Jv(z, oy), Jv(H, dy), Jv(H, uy)),
              !0 === ae.mathMl && (Jv(z, sy), Jv(H, cy), Jv(H, uy))),
            e.ADD_TAGS && (z === j && (z = Zv(z)), Jv(z, e.ADD_TAGS)),
            e.ADD_ATTR && (H === $ && (H = Zv(H)), Jv(H, e.ADD_ATTR)),
            e.ADD_URI_SAFE_ATTR && Jv(ue, e.ADD_URI_SAFE_ATTR),
            e.FORBID_CONTENTS && (ie === le && (ie = Zv(ie)), Jv(ie, e.FORBID_CONTENTS)),
            re && (z["#text"] = !0),
            Q && Jv(z, ["html", "head", "body"]),
            z.table && (Jv(z, ["tbody"]), delete q.tbody),
            Pv && Pv(e),
            (Ce = e));
        },
      ...
      var Ae = function (e) {
            ...
            : e.namespaceURI === fe
              ? t.namespaceURI === pe
                ...
                : t.namespaceURI === ge
                  ? "math" === n && Se[o]
                  : Boolean(Re[n])
              : e.namespaceURI === pe && !(t.namespaceURI === ge && !Se[o]) && !(t.namespaceURI === fe && !Ee[o]) && !Re[n] && (_e[n] || !Ne[n]);
        },
        Oe = function (e) {
        ...
        Ie = function (e) {
          ...
          return e instanceof l && !Ae(e)
            ? (Oe(e), !0)
            : ("noscript" !== o && "noembed" !== o) || !Yv(/<\/no(script|embed)/i, e.innerHTML)
              ? (X &&
                  3 === e.nodeType &&
                  ((t = e.textContent), (t = Wv(t, D, " ")), (t = Wv(t, P, " ")), e.textContent !== t && ($v(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
        ...
        Fe = function (e, t, n) {
          ...
          if (G && !W[t] && Yv(L, t));
            ...
            if (
              !(
                (Ue(e) &&
                  ((V.tagNameCheck instanceof RegExp && Yv(V.tagNameCheck, e)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(e))) &&
                  ((V.attributeNameCheck instanceof RegExp && Yv(V.attributeNameCheck, t)) || (V.attributeNameCheck instanceof Function && V.attributeNameCheck(t)))) ||
                ("is" === t &&
                  V.allowCustomizedBuiltInElements &&
                  ((V.tagNameCheck instanceof RegExp && Yv(V.tagNameCheck, n)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(n))))
              )
            )
              return !1;
          } else if (ue[t]);
        ...
        (n.sanitize = function (e, r) {
          ...
          return (
            Q &&
              ...
              Yv(yy, a.ownerDocument.doctype.name) &&
  ...
  const ky = Dt.each,
    ...
    _y = { ftp: 21, http: 80, https: 443, mailto: 25 },
    Ny = ["img", "video"],
    Ry = (e, t, n) => {
      const o = ((e) => {
        try {
      ...
      return (
        ...
        (!!/((java|vb)script|mhtml):/i.test(o) ||
          (!e.allow_html_data_urls &&
            (/^data:image\//i.test(o) ? ((e, t) => (C(e) ? !e : !C(t) || !H(Ny, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o) : /^data:/i.test(o))))
      );
    };
  class Ay {
    constructor(e, t = {}) {
    ...
    toRelative(e) {
      if ("./" === e) return e;
      const t = new Ay(e, { base_uri: this });
    ...
    toAbsolute(e, t) {
      const n = new Ay(e, { base_uri: this });
  ...
  const Dy = (e, t, n, o) => {
      ...
      return (
        ...
        n.addHook("uponSanitizeAttribute", (n, o) => {
          ...
          (o.keepAttr = Py(e, t, r, s, a)),
            o.keepAttr
              ? ((o.allowedAttributes[s] = !0), My(s, t) && (o.attrValue = s), e.allow_svg_data_urls && He(a, "data:image/svg+xml") && (o.forceKeepAttr = !0))
              : Ly(n, s) && (o.forceKeepAttr = !0);
        }),
        n
      );
    },
            ...
            t.allow_html_in_named_anchor ||
              e.addAttributeFilter("id,name", (e) => {
                let t,
                  ...
                  s = e.length;
                for (; s--; )
                  if (((r = e[s]), "a" === r.name && r.firstChild && !r.attr("href"))) for (o = r.parent, t = r.lastChild; t && o; ) (n = t.prev), o.insert(t, r), (t = n);
              }),
            t.fix_list_elements &&
    ...
    $y = (e, t, n) => {
      const o = ((e) => (eb(e) ? Ug({ validate: !1 }).serialize(e) : e))(e),
        r = t(o);
      if (r.isDefaultPrevented()) return r;
      if (eb(e)) {
        if (r.content !== o) {
          const t = Hy({ validate: !1, forced_root_block: !1, sanitize: n }).parse(r.content, { context: e.name });
          return { ...r, content: t };
        }
        return { ...r, content: e };
      }
    ...
    Vy = (e, t) => {
      if (t.no_events) return nl.value(t);
      {
        ...
        return n.isDefaultPrevented() ? nl.error($m(e, { content: "", ...n }).content) : nl.value(n);
      }
    },
    qy = (e, t, n) => {
      if (n.no_events) return t;
      {
        const o = $y(t, (t) => $m(e, { ...n, content: t }), Jd(e));
        return o.content;
      }
    },
    Wy = (e, t) => {
      if (t.no_events) return nl.value(t);
      {
        const n = $y(t.content, (n) => ((e, t) => e.dispatch("BeforeSetContent", t))(e, { ...t, content: n }), Jd(e));
        return n.isDefaultPrevented() ? (Hm(e, n), nl.error(void 0)) : nl.value(n);
      }
    },
    Ky = (e, t, n) => {
      n.no_events || Hm(e, { ...n, content: t });
    },
    Gy = (e, t, n) => ({ element: e, width: t, rows: n }),
    Yy = (e, t) => ({ element: e, cells: t }),
    Xy = (e, t) => ({ x: e, y: t }),
    ...
    eC = (e, t) => {
      ...
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++) if (xn(o[n], t)) return I.some(Xy(n, e));
      }
      return I.none();
    },
    tC = (e, t, n, o, r) => {
          ...
          const n = e.length + t.length + 2,
            ...
            i = (n, s, i, l) => {
              ...
              for (o[1 + f] = n, r[1 + f] = s + 1, g = 0; g <= f; ++g) {
                for (p = -g; p <= g; p += 2) {
                  for (
                    h = p + f, p === -g || (p !== g && o[h - 1] < o[h + 1]) ? (o[h] = o[h + 1]) : (o[h] = o[h - 1] + 1), b = o[h], v = b - n + i - p;
                    b < s && v < l && e[b] === t[v];
    ...
    fC = (e, t, n) => {
      ...
      "fragmented" === t.type ? cC(t.fragments, e.getBody()) : e.setContent(t.content, { format: "raw", no_selection: !C(o) || !bu(o) || !o.isFakeCaret }),
      ...
      undoManager: {
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            let r;
            return (
              t.typing && (t.add(), (t.typing = !1), vC(t, !1, n)),
              o.get() > 0 && (o.set(o.get() - 1), (r = t.data[o.get()]), fC(e, r, !0), e.setDirty(!0), e.dispatch("Undo", { level: r })),
              r
            );
          })(e, t, n, o),
        redo: (t, n) =>
          ((e, t, n) => {
            let o;
            return t.get() < n.length - 1 && (t.set(t.get() + 1), (o = n[t.get()]), fC(e, o, !1), e.setDirty(!0), e.dispatch("Redo", { level: o })), o;
          })(e, t, n),
        clear: (t, n) =>
          ((e, t, n) => {
        ...
        closest: (t) =>
          ((e, t) => {
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) => rb(bn(o), (n) => ue(t, (t) => ((t, n) => (cb(e, t.dom, n) ? I.some(n) : I.none()))(n, t)), n))
              .getOrNull();
          })(e, t),
            ...
            ((e, t, n, o, r, s) => {
              ...
              q(n.split(","), (t) => {
                const n = xe(a, t).getOrThunk(() => {
                    const e = { withSimilar: { state: Oa(!1), similar: !0, callbacks: [] }, withoutSimilar: { state: Oa(!1), similar: !1, callbacks: [] }, withVars: [] };
                    return (a[t] = e), e;
                  }),
                  i = () => {
                    const n = uv(e);
                ...
                } else n.withVars.push({ state: Oa(i()), similar: r, vars: s, callback: o });
              }),
                t.set(a);
            })(e, t, n, o, r, s),
            {
              ...
              .map((o) =>
                eb(t)
                  ? ((e, t, n, o) => {
                      ...
                      const r = Ug({ validate: !1 }, e.schema).serialize(n),
                        s = _r(bn(t)) ? r : Dt.trim(r);
                      return tb(e, s, o.no_selection), { content: n, html: s };
                    })(e, o, t, n)
                  : ((e, t, n, o) => {
                      if (0 === n.length || /^\s+$/.test(n)) {
                        ...
                        const s = El(e);
                        return (
                          e.schema.isValidChild(t.nodeName.toLowerCase(), s.toLowerCase()) ? ((n = r), (n = e.dom.createHTML(s, Sl(e), n))) : n || (n = r),
                          tb(e, n, o.no_selection),
                          { content: n, html: n }
                        );
                      }
                      {
                        "raw" !== o.format && (n = Ug({ validate: !1 }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 })));
                        const r = _r(bn(t)) ? n : Dt.trim(n);
                        return tb(e, r, o.no_selection), { content: r, html: r };
                      }
                    })(e, o, t, n)
              )
              .getOr({ content: t, html: eb(n.content) ? "" : n.content }))(e, t, n),
    ...
    _C = (e, t, n, o) => {
      e.bind(
        (e) => (
          (o ? Ip : Mp)(e.dom, o ? e.dom.length : 0),
          t.filter(qt).map((t) =>
            ((e, t, n, o) => {
              const r = e.dom,
                s = t.dom,
  ...
  const RC = (e) => !(!e || !e.ownerDocument) && kn(bn(e.ownerDocument), bn(e)),
    AC = (e, t, n, o) => {
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
            ...
            Wy(e, o).each((t) => {
              const n = ((e, t) => {
                  if ("raw" !== t.format) {
                    ...
                    return Ug({ validate: !1 }, e.schema).serialize(s);
                  }
                  return t.content;
                })(e, t),
        ...
        f = {
          ...
          serializer: n,
          editor: o,
          expand: (t = { type: "word" }) => u(Ef(e).expand(c(), t)),
          collapse: l,
          ...
          getNode: () =>
            ((e, t) => {
              ...
              t.collapsed ||
                ...
                Xo(n) && Xo(o) && ((n = n.length === r ? vg(n.nextSibling, !0) : n.parentNode), (o = 0 === s ? vg(o.previousSibling, !1) : o.parentNode), n && n === o && (a = n)));
    ...
    IC = [{ name: "template", replacedWith: "Advanced Template" }],
    FC = (e, t) => {
  ...
  const gw = (e, t) => {
    ...
    pw = (e) => () => e.notificationManager.open({ text: e.translate("Image uploading..."), type: "info", timeout: -1, progressBar: !0 }),
    hw = (e, t) => gw(t, { url: Ml(e), basePath: Il(e), credentials: Fl(e), handler: Ul(e) }),
    bw = (e) => {
      const t = (() => {
        let e = [];
        const t = (e) => {
                        ...
                        ? (n.url && !je(l.src, n.url) && (s = !0),
                          ...
                          wC(e) ||
                            ((t, n) => {
                              ...
                              var r;
                              d(t.src, n), Qt(bn(t), { src: Bl(e) ? ((r = n), r + (-1 === r.indexOf("?") ? "?" : "&") + new Date().getTime()) : n, "data-mce-src": o });
                            })(l, n.url))
                        : n.error &&
    ...
    vw = { remove_similar: !0, inherit: !1 },
    yw = { selector: "td,th", ...vw },
    Cw = {
      tablecellbackgroundcolor: { styles: { backgroundColor: "%value" }, ...yw },
      tablecellverticalalign: { styles: { "vertical-align": "%value" }, ...yw },
      tablecellbordercolor: { styles: { borderColor: "%value" }, ...yw },
      tablecellclass: { classes: ["%value"], ...yw },
      tableclass: { selector: "table", classes: ["%value"], ...vw },
      tablecellborderstyle: { styles: { borderStyle: "%value" }, ...yw },
      tablecellborderwidth: { styles: { borderWidth: "%value" }, ...yw },
    },
    ww = N(Cw),
    xw = Dt.each,
    kw = Na.DOM,
    ...
    Nw = (e, t) => {
      ...
      xw(t.styles, (e, t) => {
        ...
        kw.setStyles(a, { position: "absolute", left: -65535 }),
      ...
      return (
        xw(o.split(" "), (e) => {
          ...
          if (
            !(
              ("background-color" === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && ((t = s(e)), "#ffffff" === Iu(t).toLowerCase())) ||
              ("color" === e && "#000000" === Iu(t).toLowerCase())
            )
          ) {
                  ...
                  ? (p(o) || (o = [o]),
                    q(o, (e) => {
                      v(e.deep) && (e.deep = !fm(e)),
                        ...
                        fm(e) && gm(e) && ((e.mixed = !0), (e.block_expand = !0)),
              ...
              ((e) => {
                const t = e.dom,
                  ...
                  o = {
                    ...
                    alignjustify: [
                      { selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li,pre", styles: { textAlign: "justify" }, inherit: !1, preview: "font-family font-size" },
                    ],
                    bold: [
      ...
      const t = Ia(),
        ...
        r = {
          ...
          dispatchChange: () => {
            e.setDirty(!0);
            const t = mC(e);
            (t.bookmark = Zi(e.selection)), e.dispatch("change", { level: t, lastLevel: ie(r.data, o.get()).getOrUndefined() });
          },
            ...
            e.on("init", () => {
              ...
              e.on("keyup", (n) => {
                ...
                n.isDefaultPrevented() ||
                  ...
                  o.get() && t.typing && !hC(mC(e), t.data[0]) && (e.isDirty() || e.setDirty(!0), e.dispatch("TypingUndo"), o.set(!1), e.nodeChanged()));
              }),
              e.on("keydown", (e) => {
                const s = e.keyCode;
    ...
    Mw = (e, t) => {
      const n = bn(e),
        o = bn(t.container());
      return nh(n, o).map((e) => ((e, t) => ({ block: e, position: t }))(e, t));
    },
    Iw = (e, t) =>
      Xn(
        t,
    ...
    $w = (e, t, n) => (
      ...
      ((e, t) =>
        kn(t, e)
          ...
          : I.none())(t, n).fold(O(jw, e, t, n), O(zw, e, t, n))
    ),
          ...
          n.collapsed
            ? ((e, t, n) => {
                const o = Mw(e, Bi.fromRangeStart(n)),
                  r = o.bind((n) =>
                    su(t, e, n.position).bind((n) =>
                      Mw(e, n).map((n) =>
                        ((e, t, n) =>
                          nr(n.position.getNode()) && !ms(n.block)
                            ? lu(!1, n.block.dom)
                                .bind((o) => (o.isEqual(n.position) ? su(t, e, o).bind((t) => Mw(e, t)) : I.some(n)))
                                .getOr(n)
                            : n)(e, t, n)
                      )
                    )
                  );
                return Lt(o, r, Lw).filter(
                  (t) =>
    ...
    Kw = (e) => {
      ...
      return ((e, t) => {
        ...
        : ((e, t) => {
            const n = t.getRng();
            return Lt(nh(e, bn(n.startContainer)), nh(e, bn(n.endContainer)), (o, r) =>
              xn(o, r)
                ? I.none()
                : I.some(() => {
                    n.deleteContents(),
    ...
    rx = ol([{ remove: ["element"] }, { moveToElement: ["element"] }, { moveToPosition: ["position"] }]),
    sx = (e, t, n) =>
      su(t, e, n).bind((o) => {
        return (
          (r = o.getNode()),
          ...
          ((e, t, n, o) => {
            ...
            : (t && sr(o.getNode())) || (!t && sr(o.getNode(!0)))
              ? ((e, t, n, o) => {
                  const r = o.getNode(!t);
                  return nh(bn(e), bn(n.getNode()))
                    .map((e) => (ms(e) ? rx.remove(e.dom) : rx.moveToElement(r)))
                    .orThunk(() => I.some(rx.moveToElement(r)));
                })(e, t, n, o)
              : (t && rp(n)) || (!t && op(n))
                ? I.some(rx.moveToPosition(o))
                : I.none()
        );
        var r;
      }),
          ...
          () =>
            ((e, t, n) => {
              const o = Fc(t ? 1 : -1, e, n),
                ...
                s = bn(e);
              return !t && rp(r)
                ? I.some(rx.remove(r.getNode(!0)))
                : t && op(r)
                  ? I.some(rx.remove(r.getNode()))
                  : !t && op(r) && vp(s, r)
                    ? yp(s, r).map((e) => rx.remove(e.getNode()))
                    : t && rp(r) && bp(s, r)
                      ? Cp(s, r).map((e) => rx.remove(e.getNode()))
                      : ((e, t, n) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? "after" : "before";
                            ...
                            ? ((e, t) =>
                                y(t)
                                  ? I.none()
                                  : e && sr(t.nextSibling)
                                    ? I.some(rx.moveToElement(t.nextSibling))
                                    : !e && sr(t.previousSibling)
                                      ? I.some(rx.moveToElement(t.previousSibling))
                                      : I.none())(t, n.getNode(!t)).orThunk(() => sx(e, t, n))
                            : sx(e, t, n).bind((t) =>
                                ((e, t, n) =>
                                  n.fold(
                                    (e) => I.some(rx.remove(e)),
                                    (e) => I.some(rx.moveToElement(e)),
                                    (n) => (Tc(t, n, e) ? I.none() : I.some(rx.moveToPosition(n)))
                                  ))(e, n, t)
                              ))(e, t, r);
            })(e.getBody(), t, e.selection.getRng()).map(
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), Wp(e, t, bn(n)), !0))(e, t),
                  ((e, t) => (n) => {
    ...
    cx = (e, t) =>
      e.selection.isCollapsed()
        ? ((e, t) => {
            const n = Bi.fromRangeStart(e.selection.getRng());
            return su(t, e.getBody(), n)
              .filter((e) => (t ? Qg(e) : Jg(e)))
              .bind((e) => Bc(t ? 0 : -1, e))
      ...
      e
        ...
        : ((e) => {
            ...
            if (ux(e)) return fx(e) || e.appendData(Br), e;
            {
              const o = gx(e);
              return (
                e.nextSibling ? null === (t = e.parentNode) || void 0 === t || t.insertBefore(o, e.nextSibling) : null === (n = e.parentNode) || void 0 === n || n.appendChild(o), o
              );
            }
          })(t),
    hx = O(px, !0),
    ...
    xx = ol([{ before: ["element"] }, { start: ["element"] }, { end: ["element"] }, { after: ["element"] }]),
    kx = (e, t) => Oc(t, e) || e,
    Ex = (e, t, n) => {
      const o = Qp(n),
        r = kx(t, o.container());
      return Yp(e, r, o).fold(
        () =>
          du(r, o)
            .bind(O(Yp, e, r))
            .map((e) => xx.before(e)),
  ...
  const jx = (e, t) => (e === Vc.Backwards ? oe(t) : t),
    ...
    Vx = (e, t, n, o) => {
      ...
      for (; s; ) {
        ...
        if (!n) break;
        if (nr(n.getNode(!1)))
          return t === Vc.Forwards ? { positions: jx(t, a).concat([n]), breakType: zx.Br, breakAt: I.some(n) } : { positions: jx(t, a), breakType: zx.Br, breakAt: I.some(n) };
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = $x(0, t, s, n);
            return { positions: jx(t, a), breakType: e, breakAt: I.some(n) };
          }
          a.push(n), (s = n);
        } else s = n;
      }
      return { positions: jx(t, a), breakType: zx.Eol, breakAt: I.none() };
    },
    qx = (e, t, n, o) =>
      t(n, o)
        .breakAt.map((o) => {
  ...
  const ik = (e, t, n, o, r, s) => {
      ...
      return (
        c &&
          ...
          ((e, t, n, o) => {
            let r = o;
            for (; (r = Ac(r, e, os, t)); ) if (n(r)) return;
          })(e, o, l, c)),
        i
      );
    },
      ...
      if (e.selection.isCollapsed() && ad(e)) {
        ...
        return ((e, t, n, o) => {
          const r = ((e, t) => Oc(t, e) || e)(e.getBody(), o.container()),
            ...
            a = Tx(s, r, o);
          return a
            .bind((e) => (n ? e.fold(N(I.some(Lx(e))), I.none, N(I.some(Px(e))), I.none) : e.fold(I.none, N(I.some(Px(e))), I.none, N(I.some(Lx(e))))))
            .map(Ak(e, t))
            .getOrThunk(() => {
              const i = au(n, r, o),
                l = i.bind((e) => Tx(s, r, e));
    ...
    CE = { shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0 },
    wE = (e, t) => t.keyCode === e.keyCode && t.shiftKey === e.shiftKey && t.altKey === e.altKey && t.ctrlKey === e.ctrlKey && t.metaKey === e.metaKey,
    xE =
      (e, ...t) =>
      () =>
        e.apply(null, t),
    kE = (e, t) => J(((e, t) => te(((e) => V(e, (e) => ({ ...CE, ...e })))(e), (e) => (wE(e, t) ? [e] : [])))(e, t), (e) => e.action()),
    EE = (e, t) => ue(((e, t) => te(((e) => V(e, (e) => ({ ...CE, ...e })))(e), (e) => (wE(e, t) ? [e] : [])))(e, t), (e) => e.action()),
    SE = (e, t) => {
      const n = t ? Vc.Forwards : Vc.Backwards,
        o = e.selection.getRng();
    ...
    RE = ol([{ none: ["current"] }, { first: ["current"] }, { middle: ["current", "target"] }, { last: ["current"] }]),
    AE = { ...RE, none: (e) => RE.none(e) },
    ...
    PE = (e, t, n, o, r) => {
      const s = Mo(bn(n), "td,th,caption").map((e) => e.dom),
        a = G(
          ((e, t) =>
            te(t, (t) => {
              const n = ((e, t) => ({ left: e.left - t, top: e.top - t, right: e.right + -2, bottom: e.bottom + -2, width: e.width + t, height: e.height + t }))(
    ...
    IE = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === zx.Wrap && 0 === e.positions.length)(o) || (!nr(n.getNode()) && ((e) => e.breakType === zx.Br && 1 === e.positions.length)(o))
          ...
          ((e, t) =>
            le(t.getClientRects())
              ...
              .bind((e) => {
                return Kx(
                  mu((n = e))
                    .map((e) => Gx(n, e).positions.concat(e))
                    .getOr([]),
                  t
                );
                var n;
              }))(t, n)
            .orThunk(() => le(n.getClientRects()).bind((n) => Wx(Xx(e, Bi.before(t)), n.left)))
            .getOr(Bi.before(t)))(a, n, s);
        return jE(e, t, o), !0;
      }
      if (t && UE(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            de(t.getClientRects())
              .bind((t) => ME(e, t.left, t.top))
              .bind((e) => {
                return Kx(
                  uu((n = e))
                    .map((e) => [e].concat(Yx(n, e).positions))
                    .getOr([]),
                  t
                );
                var n;
              }))(t, n)
            .orThunk(() => le(n.getClientRects()).bind((n) => Wx(Qx(e, Bi.after(t)), n.left)))
            .getOr(Bi.after(t)))(a, n, s);
        return jE(e, t, o), !0;
      }
      return !1;
    },
    ...
    YE = (e, t) => {
      ...
      return ((e, t) => ((e, t, n = L) => (n(t) ? I.none() : H(e, jt(t)) ? I.some(t) : Qn(t, e.join(","), (e) => Cn(e, "table") || n(e))))(["td", "th"], e, t))(
        bn(t ? s.endContainer : s.startContainer),
        r
      )
        .map(
          (n) => (
    ...
    aS = (e, t, n, o = 0) => {
      return ((r = bn(t.startContainer)), Zn(r, xg)).fold(
        () =>
          ((e, t, n, o = 0) => {
            ...
            return nS(
              ...
              const s = oS(r);
              return 0 !== s.lastIndexOf(n) || sS(s, n).length < o ? I.none() : I.some({ text: sS(s, n), range: r, trigger: n });
            });
          })(e, t, n, o),
        (t) => {
          const o = e.createRng();
          o.selectNode(t.dom);
          const r = oS(o);
          return I.some({ range: o, text: sS(r, n), trigger: n });
        }
      );
      var r;
    },
    ...
    dS = (e, t, n, o = {}) => {
      ...
      const l = Promise.all(
        V(i, (e) => e.fetch(n.text, e.maxResults, o).then((t) => ({ matchText: n.text, items: t, columns: e.columns, onAction: e.onAction, highlightOn: e.highlightOn })))
      );
  ...
  const uS = (e, t, n) => (e.stype === cS.Error ? t(e.serror) : n(e.svalue)),
        ...
        a = (e) =>
          e.fold(
            ...
            (e) => {
              ...
              return (s = n), (a = I.some), s.stype === cS.Value ? { stype: cS.Value, svalue: a(s.svalue) } : s;
              var s, a;
            }
          );
      switch (e.tag) {
    ...
    AS = (e, t, n) => {
      return (
        (o = ((e, t, n) => ((e, t) => (e.stype === cS.Error ? { stype: cS.Error, serror: t(e.serror) } : e))(t.extract([e], n), (e) => ({ input: n, errors: e })))(e, t, n)),
  ...
  NS(
    [
      ...
      GS("initValue", N("")),
      n_,
      ((e, t) => IS(e, e, { tag: "required", process: {} }, RS(t)))("commands", h_),
      HS("launch", OS("type", { contextformbutton: g_, contextformtogglebutton: p_ })),
    ].concat(u_)
  );
  const b_ = (e) => {
    ...
    P_ = (e, t) => {
      El(e).toLowerCase() === t.tagName.toLowerCase() &&
        ((e, t, n) => {
          const o = e.dom;
          I.from(n.style)
            .map(o.parseStyle)
    ...
    L_ = {
      insert: (e, t) => {
        ...
        if (("LI" !== x || b || ((w = s), (s = s.parentNode), (r = x)), /^(LI|DT|DD)$/.test(r) && jo(s) && i.isEmpty(w)))
          return void ((e, t, n, o, r) => {
            ...
            if (R_(n, o, !0) && R_(n, o, !1))
              ...
              "LI" === r && ((e, t) => e.firstChild && "LI" === e.firstChild.nodeName)(t) ? ((d = t.firstChild), s.insertAfter(t, n)) : (s.insertAfter(t, n), s.insertAfter(d, n)),
                s.remove(o);
            }
            x_(e, d);
          })(e, f, s, w, u);
        ...
        if (Ir(w)) (E = qr(w)), i.isEmpty(w) && O_(w), P_(e, E), x_(e, E);
          ...
          ((e) => {
            ...
            i.isEmpty(w) && O_(w),
            E.normalize(),
            i.isEmpty(E) ? (i.remove(E), p()) : (P_(e, E), x_(e, E));
        }
              ...
              "LI" !== u || m || (d = c),
                Xo(l) &&
                  ...
                  (((e, t, n) => {
                    ...
                    for (; (r = o.next()); ) if (s[r.nodeName.toLowerCase()] || (Xo(r) && r.length > 0)) return !0;
                    return !1;
        ...
        r = ((e, t) =>
          wx(
            [
              tN([W_], q_.none()),
              tN([X_(!0), Y_], q_.none()),
              tN([G_("summary", !0)], q_.br()),
              tN([X_(!0), Q_(!1), Z_], q_.br()),
              tN([X_(!0), Q_(!1)], q_.block()),
              tN([X_(!0), Q_(!0), Z_], q_.block()),
              tN([X_(!0), Q_(!0)], q_.br()),
              tN([K_(!0), Z_], q_.br()),
              tN([K_(!0)], q_.block()),
              tN([J_], q_.br()),
    ...
    lN = (e, t) => {
      const n = t.container(),
        o = t.offset();
      return Xo(n)
        ? (n.insertData(o, e), I.some(Bi(n, o + e.length)))
        : jc(t).map((n) => {
            const o = hn(e);
    ...
    uN = (e, t) => (n) =>
      ((e, t) =>
        !Sp(t) &&
        (((e, t) => ((e, t) => cu(e.dom, t).isNone())(e, t) || ((e, t) => du(e.dom, t).isNone())(e, t) || up(e, t) || mp(e, t) || vp(e, t) || bp(e, t))(e, t) ||
          kp(e, t) ||
          Ep(e, t)))(e, n)
        ? dN(t)
        : cN(t),
    mN = (e) => {
      ...
      if (e.selection.isCollapsed()) {
        ...
        return Tx(o, e.getBody(), r)
          .bind(
            (
              (e) => (t) =>
                t.fold(
                  (t) => cu(e.dom, Bi.before(t)),
                  (e) => uu(e),
                  (e) => mu(e),
                  (t) => du(e.dom, Bi.after(t))
                )
            )(n)
          )
          .map((o) => () => uN(n, t)(o).each(((e) => (t) => (e.selection.setRng(t.toRange()), e.nodeChanged(), !0))(e)));
      }
      return I.none();
    },
    fN = (e) =>
      ec(e)
        ? [
            { keyCode: qm.TAB, action: xE(YE, e, !0) },
            { keyCode: qm.TAB, shiftKey: !0, action: xE(YE, e, !1) },
          ]
        : [],
    gN = (e) => {
        ...
        return (
            ...
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  kE(
                    [
                      { keyCode: qm.RIGHT, action: xE(fE, e, !0) },
                      { keyCode: qm.LEFT, action: xE(fE, e, !1) },
                      { keyCode: qm.UP, action: xE(gE, e, !1) },
                      { keyCode: qm.DOWN, action: xE(gE, e, !0) },
                      ...(o
                        ? [
                            { keyCode: qm.UP, action: xE(hE, e, !1), metaKey: !0, shiftKey: !0 },
                            { keyCode: qm.DOWN, action: xE(hE, e, !0), metaKey: !0, shiftKey: !0 },
                          ]
                        : []),
                      { keyCode: qm.RIGHT, action: xE(VE, e, !0) },
                      { keyCode: qm.LEFT, action: xE(VE, e, !1) },
                      { keyCode: qm.UP, action: xE(qE, e, !1) },
                      { keyCode: qm.DOWN, action: xE(qE, e, !0) },
                      { keyCode: qm.RIGHT, action: xE(SE, e, !0) },
                      { keyCode: qm.LEFT, action: xE(SE, e, !1) },
                      { keyCode: qm.UP, action: xE(_E, e, !1) },
                      { keyCode: qm.DOWN, action: xE(_E, e, !0) },
                      { keyCode: qm.RIGHT, action: xE(kk, e, t, !0) },
                      { keyCode: qm.LEFT, action: xE(kk, e, t, !1) },
                      { keyCode: qm.RIGHT, ctrlKey: !o, altKey: o, action: xE(_k, e, t) },
                      { keyCode: qm.LEFT, ctrlKey: !o, altKey: o, action: xE(Nk, e, t) },
                      { keyCode: qm.UP, action: xE(yE, e, !1) },
                      { keyCode: qm.DOWN, action: xE(yE, e, !0) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              (n = o.keyCode === qm.BACKSPACE),
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    EE(
                      [
                        { keyCode: qm.BACKSPACE, action: xE(Qk, e) },
                        { keyCode: qm.BACKSPACE, action: xE(dx, e, !1) },
                        { keyCode: qm.DELETE, action: xE(dx, e, !0) },
                        { keyCode: qm.BACKSPACE, action: xE(tx, e, !1) },
                        { keyCode: qm.DELETE, action: xE(tx, e, !0) },
                        { keyCode: qm.BACKSPACE, action: xE(Tk, e, t, !1) },
                        { keyCode: qm.DELETE, action: xE(Tk, e, t, !0) },
                        { keyCode: qm.BACKSPACE, action: xE(Oh, e, !1) },
                        { keyCode: qm.DELETE, action: xE(Oh, e, !0) },
                        { keyCode: qm.BACKSPACE, action: xE(cx, e, !1) },
                        { keyCode: qm.DELETE, action: xE(cx, e, !0) },
                        { keyCode: qm.BACKSPACE, action: xE($k, e, !1) },
                        { keyCode: qm.DELETE, action: xE($k, e, !0) },
                        { keyCode: qm.BACKSPACE, action: xE(Gw, e, !1) },
                        { keyCode: qm.DELETE, action: xE(Gw, e, !0) },
                        { keyCode: qm.BACKSPACE, action: xE(qw, e, !1) },
                        { keyCode: qm.DELETE, action: xE(qw, e, !0) },
                        { keyCode: qm.BACKSPACE, action: xE(Uk, e, !1) },
                        { keyCode: qm.DELETE, action: xE(Uk, e, !0) },
                      ],
                      n
                    )
                ...
                t.isDefaultPrevented() ||
                  ((e, t, n) => {
                    const o = xt(),
                      ...
                      a = r.isMacOS()
                        ? [
                            { keyCode: qm.BACKSPACE, altKey: !0, action: xE(jk, e) },
                            { keyCode: qm.DELETE, altKey: !0, action: xE(jk, e) },
                          ]
                        : [
                            { keyCode: qm.BACKSPACE, ctrlKey: !0, action: xE(jk, e) },
                            { keyCode: qm.DELETE, ctrlKey: !0, action: xE(jk, e) },
                          ];
                    r.isMacOS() && n && a.push({ keyCode: s.isFirefox() ? 224 : 91, action: xE(jk, e) }),
                      kE([{ keyCode: qm.BACKSPACE, action: xE(lx, e) }, { keyCode: qm.DELETE, action: xE(lx, e) }, ...a], t);
                  })(e, t, n),
                  (n = !1);
              });
          })(e, t),
          ...
          ((e) => {
            e.on("keydown", (t) => {
              t.isDefaultPrevented() ||
                ((e, t) => {
                  EE([{ keyCode: qm.SPACEBAR, action: xE(mN, e) }], t).each((n) => {
            ...
            e.on("input", (t) => {
              t.isComposing ||
                ((e) => {
                  const t = bn(e.getBody());
                  e.selection.isCollapsed() &&
                    Pp(t, Bi.fromRangeStart(e.selection.getRng())).each((t) => {
                      e.selection.setRng(t.toRange());
                    });
                })(e);
            });
            ...
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  kE(
                    [
                      { keyCode: qm.END, action: xE(pE, e, !0) },
                      { keyCode: qm.HOME, action: xE(pE, e, !1) },
                      ...(o
                        ? []
                        : [
                            { keyCode: qm.HOME, action: xE(hE, e, !1), ctrlKey: !0, shiftKey: !0 },
                            { keyCode: qm.END, action: xE(hE, e, !0), ctrlKey: !0, shiftKey: !0 },
                          ]),
                      { keyCode: qm.END, action: xE(NE, e, !0) },
                      { keyCode: qm.HOME, action: xE(NE, e, !1) },
                      { keyCode: qm.END, action: xE(Rk, e, !0, t) },
                      { keyCode: qm.HOME, action: xE(Rk, e, !1, t) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              e.on("keyup", (o) => {
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    kE(
                      [
                        { keyCode: qm.PAGE_UP, action: xE(Rk, e, !1, t) },
                        { keyCode: qm.PAGE_DOWN, action: xE(Rk, e, !0, t) },
                      ],
                      n
                    );
                  })(e, t, o),
                  aN(o) && n.get() && (iN(n, e, !1), e.nodeChanged());
              });
          })(e, t),
          t
        );
  ...
  const hN = N("x-tinymce/html"),
    ...
    SN = (e) =>
      EN(e, [
        ...
        [/( ?)<span class="Apple-converted-space">\u00a0<\/span>( ?)/g, (e, t, n) => (t || n ? ur : " ")],
        /<br class="Apple-interchange-newline">/g,
        /<br>$/i,
      ]),
    _N = (e, t) => ({ content: e, cancelled: t }),
    NN = (e, t) => (e.insertContent(t, { merge: zd(e), paste: !0 }), !0),
    RN = (e) => /^https?:\/\/[\w\-\/+=.,!;:&%@^~(){}?#]+$/i.test(e),
    AN = (e, t, n) =>
      !(e.selection.isCollapsed() || !RN(t)) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
    ...
    ON = (e, t, n) =>
      !!((e, t) => RN(t) && $(Zd(e), (e) => $e(t.toLowerCase(), `.${e.toLowerCase()}`)))(e, t) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
      ...
      const r = ((e, t, n) =>
        ((e, t, n) => {
          const o = ((e, t, n) => e.dispatch("PastePreProcess", { content: t, internal: n }))(e, t, n),
            r = ((e, t) => {
              const n = Hy({ sanitize: Jd(e) }, e.schema);
              ...
              return Ug({ validate: !0 }, e.schema).serialize(o);
            })(e, o.content);
    ...
    FN = (e, t, n) => {
      ...
      if (Ld(e) && o) {
        ...
        if (s.length > 0)
          return (
            t.preventDefault(),
            ((r = s), Promise.all(V(r, (e) => vv(e).then((t) => ({ file: e, uri: t }))))).then((t) => {
      ...
      ((e, t, n) => {
        ...
        e.on("keydown", (e) => {
          ...
          e.on("paste", (r) => {
            ...
            (!IN(a) && FN(e, r, t.getLastRng() || e.selection.getRng())) ||
              (MN(a, "text/html")
                ? (r.preventDefault(), UN(e, a, a["text/html"], s))
                : MN(a, "text/plain") && MN(a, "text/uri-list")
                  ? (r.preventDefault(), UN(e, a, a["text/plain"], s))
                  : (t.create(),
                    og.setEditorTimeout(
                      e,
                      () => {
    ...
    $N = (e) => ({ html: vN(e.selection.getContent({ contextual: !0 })), text: e.selection.getContent({ format: "text" }) }),
  ...
  const sR = (e, t) => Math.abs(e.left - t),
    ...
    cR = (e, t, n) =>
      ((e, t, n) => {
        ...
        .filter((e) => hc(e.node))
        .map((e) => ((e, t) => ({ node: e.node, position: sR(e, t) < aR(e, t) ? rR.Before : rR.After }))(e, t)),
    uR = (e) => {
      var t, n;
    ...
    mR = (e) => ({ target: e, srcElement: e }),
    fR = (e) => (t, n) => ((e, t, n) => ({ ...t, dataTransfer: null, type: e, ...n }))(e, t, mR(n)),
    gR = fR("dragstart"),
    pR = fR("drop"),
    hR = (e) =>
      ((e, t) => {
          ...
          if (e.dragging) {
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) => (e.inline ? uR(e.getBody()) : { left: 0, top: 0 }))(e)),
                    (o = ((e) => {
                      const t = e.getBody();
          ...
          e.on((e) => {
            ...
            if ((e.intervalId.clear(), e.dragging)) {
              if (
                ...
                t.dispatch("drop", pR(n, s)).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    ((e, t) => {
            ...
            if (l(o))
              return ((o) => {
                ...
                const d = ((o, r) => {
                  ...
                  c = bn(o);
                return (
                  q(Mo(bn(e.getBody()), "*[data-mce-selected]"), (e) => {
                    xn(c, e) || tn(e, a);
                  }),
      ...
      return (
        wC(e) ||
          ...
          e.on("mousedown", (r) => {
              ...
              !((e, t, n) => {
                const o = bn(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return { x: n - (e ? r.left + t.dom.clientLeft + ew(t) : 0), y: o - (e ? r.top + t.dom.clientTop + ZC(t) : 0) };
                  })(e.inline, r, t, n);
                return ((e, t, n) => {
                  const o = QC(e),
                    r = JC(e);
            ...
            const a = BR(e, s);
            TR(a)
              ? (r.preventDefault(), Xw(e, a).each(f))
              : cR(o, r.clientX, r.clientY).each((n) => {
                  var o;
    ...
    MR = (e, t, n, o, r, s, a = !1) => ({ start: LR(e, t, n, o, a), end: LR(e, t, r, s, a) }),
    IR = (e, t) => {
      const n = t.slice(),
        o = n.pop();
      return x(o)
        ? X(n, (e, t) => e.bind((e) => I.from(e.childNodes[t])), I.some(e)).bind((e) => (Xo(e) && (o < 0 || o > e.data.length) ? I.none() : I.some({ node: e, offset: o })))
        : I.none();
    },
    FR = (e, t) =>
      IR(e, t.start).bind(({ node: n, offset: o }) =>
        IR(e, t.end).map(({ node: e, offset: t }) => {
          const r = document.createRange();
    ...
    HR = (e, t, n) => {
      ...
      return { ...e, blockPatterns: il(o).concat(e.blockPatterns), inlinePatterns: ll(o).concat(e.inlinePatterns) };
    },
    $R = (e, t, n, o) => {
      const r = e.createRng();
    ...
    qR = (e, t) => e.create("span", { "data-mce-type": "bookmark", id: t }),
    WR = (e, t) => {
      const n = e.createRng();
    ...
    KR = (e, t, n) => {
      const o = FR(e.getRoot(), n).getOrDie("Unable to resolve path range"),
        ...
        l = i.parentNode;
      return { prefix: t, end: a.parentNode.insertBefore(qR(e, t + "-end"), a), start: l.insertBefore(qR(e, t + "-start"), i) };
    },
    GR = (e, t, n) => {
      ...
      return nS(
        ...
        }
        {
          ...
          return eS(o.container, s, n)
            ...
            .orThunk(() => XR(e, t, n, XE(o.container, 0)));
        }
      });
    },
    QR = (e, t, n, o) => {
      ...
      return eS(i, l - n.pattern.end.length, t).bind((d) => {
        ...
        if (YR(a)) return I.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
        {
          ...
          return m.map((e) => {
            ...
            return { matches: l.matches.concat([{ pattern: a, startRng: t, endRng: c }]), position: XE(e.startContainer, e.startOffset) };
          });
        }
      });
    },
    JR = (e, t, n, o, r, s) => {
      ...
      return ZE(n, o, a.getRoot()).bind((i) => {
        ...
        for (let a = 0; a < t.length; a++) {
          ...
          const c = t.slice();
          c.splice(a, 1);
          const u = QR(e, r, { pattern: d, remainingPatterns: c, position: i }, s);
    ...
    eA = (e, t, n, o, r, s) => {
      ...
      return ((e, t) => {
        ...
        JR(e, r.inlinePatterns, n, o, t, s).fold(
          () => [],
          (e) => e.matches
        ),
        JR(e, ((a = r.inlinePatterns), ae(a, (e, t) => t.end.length - e.end.length)), n, o, t, s).fold(
          () => [],
          (e) => e.matches
        )
      );
          ...
          const s = Math.max(0, n.startOffset),
            ...
            l = ((e, t, n, o) => {
              ...
              return ((e, t) => {
                ...
                .map((e) => (Dt.trim(i).length === e.start.length ? [] : [{ pattern: e, range: MR(s, s.getRoot(), t, 0, t, 0, true) }]))
                .getOr([]);
            })(e, o, a);
          return (
    ...
    mA = (e) => {
      !0 !== e.removed &&
        (((e) => {
          wC(e) || e.load({ initial: !0, format: "html" }), (e.startContent = e.getContent({ format: "raw" }));
        })(e),
        ((e) => {
    ...
    fA = (e) => {
      ...
      (o.disabled = !0),
        (e.readonly = yd(e)),
        e.readonly || (e.inline && "static" === sA.getStyle(o, "position", !0) && (o.style.position = "relative"), (o.contentEditable = "true")),
        (o.disabled = !1),
        (e.editorUpload = bw(e)),
        (e.schema = ia(dA(e))),
        (e.dom = Na(n, {
          ...
          a.length > 0 &&
            ...
            e.serializer.addAttributeFilter(t, (e) => {
              ...
              for (; n--; ) {
                const o = e[n];
                (r(o) || s(o)) &&
                  (a.length > 0 && o.attr("data-mce-content") ? ((o.name = "#text"), (o.type = 3), (o.raw = !0), (o.value = o.attr("data-mce-content"))) : o.attr(t, null));
              }
            });
        })(e),
        wC(e) ||
          ...
          ((e) => {
            ((e) => {
              const t = [",", ".", ";", ":", "!", "?"],
                n = [32],
                o = () => {
                  return (t = qd(e)), (n = Wd(e)), { inlinePatterns: ll(t), blockPatterns: il(t), dynamicPatternsLookup: n };
                  var t, n;
                },
        ...
        ((e) => {
          ...
          const n = e.dom,
            ...
            s = (t, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) => Dw(e) && !(Pw(e) || ("keyup" === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (ms(bn(t), !1)) {
              ...
              (("" !== n.getAttrib(i, Bw)) !== l || a) &&
                (n.setAttrib(i, Bw, l ? r : null),
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          Bd(e) || ((t.body.spellcheck = !1), sA.setAttrib(n, "spellcheck", "false")),
          (e.quirks = rA(e)),
          ((e) => {
            ...
            e.setProgressState(!0),
              uA(e).then(() => {
                t().then(
                  ...
                  (t) => {
                    e.notificationManager.open({ type: "error", text: String(t) }), mA(e), EC(e);
                  }
                );
              });
          }
    ...
    pA = Na.DOM,
    hA = Na.DOM,
    bA = (e, t) => ({ editorContainer: e, iframeContainer: t, api: {} }),
    vA = (e) => {
      const t = e.getElement();
      return e.inline
        ? bA(null)
      ...
      e.dispatch("ScriptsLoaded"),
        ((e) => {
          const t = Dt.trim(Pl(e)),
            ...
            o = { ...KC.get("default").icons, ...KC.get(t).icons };
          ge(o, (t, o) => {
              ...
              if (((n = Dt.trim(n)), o && -1 === Dt.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    ...
                    Um(e, "PluginLoadError", { message: o }), dw(o, n), aw(e, o);
                  })(e, n, t);
                }
              }
            })(e, t, ((e) => e.replace(/^\-/, ""))(n));
        ...
        e.inline
          ...
          : ((e, t) => {
              ((e, t) => {
                ...
                (r.onload = () => {
                  ...
                  (e.iframeHTML = ((e) => {
                    ...
                    const n = Cl(e),
                      ...
                      r = e.translate(Nd(e));
                    return (
                      xl(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + xl(e) + '" />'),
                ...
                t.editorContainer && ((t.editorContainer.style.display = e.orgDisplay), (e.hidden = pA.isHidden(t.editorContainer))),
        ...
        ((e, t, n) => {
          const o = xA(t, "default", n),
            r = ((e) =>
              I.from(Ll(e))
                .filter(Ge)
                .map((e) => ({ url: e, name: I.none() })))(t).orThunk(() => xA(t, Pl(t), ""));
          q(
            ((e) => {
              const t = [],
                n = (e) => {
    ...
    OA = (e, t) => ({ table_grid: !1, object_resizing: !1, resize: !1, toolbar_mode: xe(e, "toolbar_mode").getOr("scrolling"), toolbar_sticky: !1, ...(t ? { menubar: !1 } : {}) }),
    TA = (e, t) => {
      var n;
    ...
    BA = (e, t, n, o, r) => {
      var s;
      const a = e ? { mobile: OA(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) } : {},
        i = RA(["mobile"], yS(a, r)),
        l = Dt.extend(
          n,
          o,
          i.options(),
          ((e, t) => e && AA(t, "mobile"))(e, i)
            ? ((e, t, n = {}) => {
                const o = e.sections(),
                  r = xe(o, t).getOr({});
    ...
    PA = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              (n = Np(o, Bi.fromRangeStart(t)) ? n.replace(/^ /, "&nbsp;") : n.replace(/^&nbsp;/, " ")),
    ...
    LA = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        Wy(e, { ...o, content: PA(e, n), format: "html", set: !1, selection: !0 }).each((t) => {
          const n = ((e, t, n) => xC(e).editor.insertContent(t, n))(e, t.content, o);
          Ky(e, n, t), e.addVisual();
        });
      }
    },
    MA = { "font-size": "size", "font-family": "face" },
    IA = Gt("font"),
    FA = (e) => (t, n) =>
      I.from(n)
        .map(bn)
        ...
        .bind((n) =>
          ((e, t, n) =>
            rb(
              bn(n),
              (t) => ((t) => lo(t, e).orThunk(() => (IA(t) ? xe(MA, e).bind((e) => Zt(t, e)) : I.none())))(t),
              (e) => xn(bn(t), e)
            ))(e, t, n.dom).or(((e, t) => I.from(Na.DOM.getStyle(t, e, !0)))(e, n.dom))
        )
        .getOr(""),
    UA = FA("font-size"),
      ...
      DA(e),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            insertImage: (t, n, o) => {
              LA(e, e.dom.createHTML("img", { src: o }));
            },
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            e.editorCommands.addCommands({ Outdent: () => Wk(e) }, "state");
        })(e),
        ((e) => {
          e.editorCommands.addCommands({
            insertParagraph: () => {
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = $A(e, t);
                  e.formatter.toggle("fontname", { value: VA(n) }), e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: $A(e, t) }), e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
                ((e, t) => {
  ...
  const lO = (e, t) => {
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized && n.delegates && (n.dom.unbind(lO(n, e), e, n.delegates[e]), delete n.delegates[e])));
      },
    ...
    mO = (e) =>
      m(e) ? { value: e.split(/[ ,]/), valid: !0 } : k(e, m) ? { value: e, valid: !0 } : { valid: !1, message: "The value must be a string[] or a comma/space separated string." },
    ...
    vO = Dt.each,
    yO = Dt.explode,
    CO = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
      ...
      vO(yO(e.toLowerCase(), "+"), (e) => {
        ((e) => e in wO)(e)
          ...
          : /^[0-9]{2,}$/.test(e)
            ...
            : ((t.charCode = e.charCodeAt(0)), (t.keyCode = CO[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
  ...
  class RO {
    constructor(e, t, n) {
      ...
      (this.options = ((e, t) => {
        ...
        ((e) => {
          ...
          t("id", { processor: "string", default: e.id }),
            ...
            t("body_id", { processor: hl(e, "tinymce"), default: "tinymce" }),
            t("body_class", { processor: hl(e), default: "" }),
            ...
            t("font_css", {
              processor: (e) => {
                const t = m(e) || k(e, m);
                return t ? { value: p(e) ? e : V(e.split(","), qe), valid: t } : { valid: !1, message: "Must be a string or an array of strings." };
              },
              default: [],
            }),
            ...
            t("invalid_styles", { processor: pl }),
            t("valid_children", { processor: "string" }),
            t("valid_classes", { processor: pl }),
            t("valid_elements", { processor: "string" }),
            t("valid_styles", { processor: pl }),
            ...
            t("text_patterns", {
              processor: (e) => (k(e, f) || !1 === e ? { value: dl(!1 === e ? [] : e), valid: !0 } : { valid: !1, message: "Must be an array of objects or false." }),
              default: [
            ...
            t("noneditable_regexp", {
              processor: (e) => (k(e, fl) ? { value: e, valid: !0 } : fl(e) ? { value: [e], valid: !0 } : { valid: !1, message: "Must be a RegExp or an array of RegExp." }),
              default: [],
            }),
            ...
            e.on("ScriptsLoaded", () => {
              t("directionality", { processor: "string", default: Pa.isRtl() ? "rtl" : void 0 }),
                t("placeholder", { processor: "string", default: ml.getAttrib(e.getElement(), "placeholder") });
            });
        })(o);
      ...
      C(d) && Na.DOM.styleSheetLoader._setContentCssCors(d),
        ...
        this.setDirty(!1),
        (this.documentBaseURI = new Ay(yl(o), { base_uri: this.baseUri })),
      ...
      c && (At.cacheSuffix = c.replace(/^[\?\&]+/, "")),
        (this.ui = { registry: EO(), styleSheetLoader: void 0, show: E, hide: E, setEnabled: E, isEnabled: M }),
        (this.mode = ((e) => {
          const t = Oa("design"),
            n = Oa({ design: { activate: E, deactivate: E, editorReadOnly: !1 }, readonly: { activate: E, deactivate: E, editorReadOnly: !0 } });
          return (
            ((e) => {
              e.serializer
                ? eO(e)
    ...
    render() {
      ((e) => {
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) => Ts.forElement(e, { contentCssCors: Cd(t), referrerPolicy: jl(t) }))(o, e)),
          md(e) ? (e.inline = !0) : ((e.orgVisibility = e.getElement().style.visibility), (e.getElement().style.visibility = "hidden"));
        const s = e.getElement().form || CA.getParent(t, "form");
        s &&
          ((e.formElement = s),
          fd(e) && !Yo(e.getElement()) && (CA.insertAfter(CA.create("input", { type: "hidden", name: t }), t), (e.hasHiddenInput = !0)),
    ...
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (SO.hide(e.getContainer()), SO.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    insertContent(e, t) {
      t && (e = _O({ content: e }, t)), this.execCommand("mceInsertContent", !1, e);
    }
    resetContent(e) {
      void 0 === e ? DC(this, this.startContent, { format: "raw" }) : DC(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged();
    }
    isDirty() {
    ...
    destroy(e) {
      ((e, t) => {
        ...
        e.destroyed ||
          (t || e.removed
            ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), WC(n), WC(o)),
              ((e) => {
              ...
              ((e) =>
                At.browser.isIE() || At.browser.isEdge()
                  ? (dw(
                    ...
                    [])
                  : IO
                    ? (dw("Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode."), [])
                    : m(e.selector)
                      ? AO.select(e.selector)
                      : C(e.target)
                        ? [e.target]
                        : [])(e)
            )),
            ...
            0 === i.length
              ...
              : OO(i, (s) => {
                  ((e, t) => e.inline && t.tagName.toLowerCase() in o)(e, s)
                    ? dw("Could not initialize inline editor on invalid inline target element", s)
                    : ((e, o, s) => {
        ...
        if (e) {
          if (!m(e))
            return (
              ...
              h(t.get(n.id))
                ? null
                : (MO(n) && t.dispatch("RemoveEditor", { editor: n }), 0 === DO.length && window.removeEventListener("beforeunload", TO), n.remove(), LO(DO.length > 0), n)
            );
          OO(AO.select(e), (e) => {
            (n = t.get(e.id)), n && t.remove(n);
          });
        } else for (let e = DO.length - 1; e >= 0; e--) t.remove(DO[e]);
      },
      execCommand(e, t, n) {
        var o;
        const r = this,
        ...
        load: (n, o) => {
          ...
          if (void 0 !== e[n]) return e[n];
          {
            const a = new Promise((e, a) => {
              ...
              (t[n] = i.resolve),
                Aa.ScriptLoader.loadScript(o).then(
                  () => i.start(s),
                  () => i.reject(r)
                );
            });
  ...
  const GO = {
      ...
      util: {
        ...
        ImageUploader: (e) => {
          const t = mw(),
            n = hw(e, t);
          return { upload: (t, o = !0) => n.upload(t, o ? pw(e) : void 0) };
        },
      },
      dom: {
        EventUtils: ba,
      ...
      html: { Styles: la, Entities: Gs, Node: Ag, Schema: ia, DomParser: Hy, Writer: Fg, Serializer: Ug },
      Env: At,
      AddOnManager: La,
      Annotator: Mm,
      Formatter: Rw,
