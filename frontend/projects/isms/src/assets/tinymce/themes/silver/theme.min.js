...
!(function () {
  ...
  const M = Array.prototype.slice,
    ...
    Oo = (e) => {
      const t = e.current,
        o = e.version,
        n = (e) => () => t === e;
      return { current: t, version: o, isWindows: n(vo), isiOS: n("iOS"), isAndroid: n(yo), isMacOS: n(wo), isLinux: n(xo), isSolaris: n(So), isFreeBSD: n(ko), isChromeOS: n(Co) };
    },
      ...
      const n = lo.browsers(),
        ...
        i = ((e, t, o, n) => {
          const r = e.isiOS() && !0 === /ipad/i.test(o),
            ...
            u = !c && !l && !d;
          return { isiPad: x(r), isiPhone: x(s), isTablet: x(l), isPhone: x(c), isTouch: x(i), isAndroid: e.isAndroid, isiOS: e.isiOS, isWebView: x(d), isDesktop: x(u) };
        })(a, s, e, o);
  ...
  const Do = () => Mo(),
    Bo = (e) => {
      const t = Ve(
        ...
        n = () => e.preventDefault(),
        r = y(n, o);
      return ((e, t, o, n, r, s, a) => ({ target: e, x: t, y: o, stop: n, prevent: r, kill: s, raw: a }))(t, e.clientX, e.clientY, o, n, r, e);
    },
    Fo = (e, t, o, n, r) => {
      const s = ((e, t) => (o) => {
        e(o) && t(Bo(o));
  ...
  const an = (e, t, o) => (e.stype === sn.Error ? t(e.serror) : o(e.svalue)),
    ...
    Cn = (e) => ({ extract: (t, o) => ((e, t) => (e.stype === sn.Error ? t(e.serror) : e))(e(o), (e) => ((e, t) => kn(e, x(t)))(t, e)), toString: x("val") }),
    On = Cn(dn),
    ...
    qn = (e, t, o) => {
      return (
        (n = ((e, t, o) => ((e, t) => (e.stype === sn.Error ? { stype: sn.Error, serror: t(e.serror) } : e))(t.extract([e], o), (e) => ({ input: o, errors: e })))(e, t, o)),
        ...
        value: Vr({
          can: (e, t) => {
            ...
            return (
              ...
              (console.warn(is() + " did not get interpreted by the desired target. \nOriginator: " + na(n) + "\nTarget: " + na(r) + "\nCheck the " + is() + " event handlers"), !1)
            );
          },
        }),
      }))(is()),
  ...
  const la = (e) => {
    ...
    Ea = (e) => ({ classes: u(e.classes) ? [] : e.classes, attributes: u(e.attributes) ? {} : e.attributes, styles: u(e.styles) ? {} : e.styles }),
    Aa = (e) => e.cHandler,
    ...
    Ra = Dn([
      Qn("dom", "dom", { tag: "required", process: {} }, Dn([or("tag"), yr("styles", {}), yr("classes", []), yr("attributes", {}), ur("value"), ur("innerHtml")])),
      or("components"),
      or("uid"),
      yr("events", {}),
      yr("apis", {}),
  ...
  const _i = x(Dn(Oi())),
    ...
    Ni = (e) => er(e, w),
    Vi = x(Ti),
    zi = (e, t, o, n, r, s, a, i = !1) => ({ x: e, y: t, bubble: o, direction: n, placement: r, restriction: s, label: `${a}-${r}`, alwaysFit: i }),
    Hi = Ar([{ southeast: [] }, { southwest: [] }, { northeast: [] }, { northwest: [] }, { south: [] }, { north: [] }, { east: [] }, { west: [] }]),
    Li = Hi.southeast,
    Pi = Hi.southwest,
    Ui = Hi.northeast,
    Wi = Hi.northwest,
  ...
  const Gl = Hl.relative,
    ...
    Yl = (e, t, o, n) => {
      const r = e.bubble,
        ...
        y = { rect: h, maxHeight: v, maxWidth: b, direction: e.direction, placement: e.placement, classes: { on: r.classesOn, off: r.classesOff }, layout: e.label, testY: l };
      ...
      const r = ((e, t, o, n) => {
        ...
        return ((e, t, o, n, r, s) => {
          ...
          return j(
            ...
            Kl.nofit(
              { rect: o, maxHeight: n.height, maxWidth: n.width, direction: Li(), placement: "southeast", classes: { on: [], off: [] }, layout: "none", testY: o.y },
              -1,
              -1,
              !1
            )
  ...
  const Oc = Ar([{ screen: ["point"] }, { absolute: ["point", "scrollLeft", "scrollTop"] }]),
  ...
  var gd = [
    ...
    pd = Jn("type", { selection: td, node: Rc, hotspot: kc, submenu: gd, makeshift: Cc });
            ...
            i = ((e, t, o, n, r, s) =>
              ((e, t, o, n, r, s, a, i) => {
                const l = dc(a, "maxHeightFunction", lc()),
                  ...
                  d = e.anchorBox,
                  u = e.origin,
                  m = { bounds: Wl(u, s), origin: u, preference: n, maxHeightFunction: l, maxWidthFunction: c, lastPlacement: r, transition: i };
                return uc(d, t, o, m);
              })(((e, t) => ((e, t) => ({ anchorBox: e, origin: t }))(e, t))(t.anchorBox, e), n.element, t.bubble, t.layouts, r, o, t.overrides, s))(d, e, r, n, c, a.transition);
          o.set(n.uid, i);
        }),
          r.fold(
            () => {
  ...
  const $d = Ol({ fields: jd, name: "sandboxing", active: Wd, apis: Ud, state: Gd }),
    qd = x("dismiss.popups"),
  ...
  var au = Object.freeze({ __proto__: null, memory: ru, dataset: su, manual: () => _a({ readState: b }), init: (e) => e.store.manager.state(e) });
  const iu = (e, t, o, n) => {
    const r = t.store;
  ...
  const mu = Ol({
          ...
          ? ((e, t, o, n) =>
              e.exists((e) => e !== o.owner)
                ...
                : be(n, o.name).fold(
                    () => {
                      throw new Error(
                        "Unknown placeholder component: " + o.name + "\nKnown: [" + ae(n) + "]\nNamespace: " + e.getOr("none") + "\nSpec: " + JSON.stringify(o, null, 2)
                      );
                    },
                    (e) => e.replace()
                  ))(e, 0, o, n)
    ...
    ku = yu.multiple,
    Cu = x(vu),
    Ou = Ar([{ required: ["data"] }, { external: ["data"] }, { optional: ["data"] }, { group: ["data"] }]),
    ...
    Wu = Hu(Ou.group, Nu),
    ju = x("entirety");
  var Gu = Object.freeze({ __proto__: null, required: Lu, external: Pu, optional: Uu, group: Wu, asNamedPart: Vu, name: zu, asCommon: (e) => e.fold(w, w, w, w), original: ju });
  const $u = (e, t, o, n) => fn(t.defaults(e, o, n), o, { uid: e.partUids[t.name] }, t.overrides(e, o, n)),
    ...
    Xu = (e, t) => ({ uiType: Cu(), owner: e, name: t }),
    Ku = (e, t, o) => ({ uiType: Cu(), owner: e, name: t, config: o, validated: {} }),
    Yu = (e) =>
      X(e, (e) =>
        e
        ...
        return (
          le(r, (o) => {
            if (!1 === o.used() && o.required())
              throw new Error(
                "Placeholder: " + o.name() + " was not found in components list\nNamespace: " + e.getOr("none") + "\nComponents: " + JSON.stringify(t.components, null, 2)
              );
          }),
          s
        );
  ...
  const cm = (e, t, o, n, r) => {
      const s = ((e, t) => (e.length > 0 ? [lr("parts", e)] : []).concat([or("uid"), yr("dom", {}), yr("components", []), Ni("originalSpec"), yr("debug.sketcher", {})]).concat(t))(
        n,
        r
      );
    ...
    hm = (e) => {
      ...
      return { name: t.name, partFields: t.partFields, configFields: t.configFields, sketch: (e) => dm(t.name, t.configFields, t.partFields, t.factory, e), parts: o, ...n, ...r };
    },
    fm = (e) => (Ke("input")(e) && "radio" !== Ot(e, "type")) || Ke("textarea")(e);
  var bm = Object.freeze({ __proto__: null, getCurrent: (e, t, o) => t.find(e) });
  const vm = [or("find")],
    ym = Ol({ fields: vm, name: "composing", apis: bm }),
  ...
  const Fm = Ol({ fields: Bm, name: "disabling", active: Dm, apis: Mm }),
    Im = (e, t, o, n) => {
  ...
  const Wm = Ol({ fields: Um, name: "highlighting", apis: Pm }),
    jm = [8],
    Gm = [9],
    $m = [13],
    qm = [27],
  ...
  const Cg = (e) => (t, o, n, r) => {
    ...
    Lg = (e) => (t, o, n, r) =>
      Fg(t, o, n.selector).bind((t) => e(t.candidates, t.index, r.getNumRows().getOr(n.initSize.numRows), r.getNumColumns().getOr(n.initSize.numColumns))),
    ...
    $g = x([
      ...
      lg(rg([sg, ng(Gm)]), Pg),
      lg(rg([ig, ng(Gm)]), Pg),
      lg(ng(Xm.concat($m)), (e, t, o, n) => ((e, t) => t.focusManager.get(e).bind((e) => hi(e, t.selector)))(e, o).bind((n) => o.execute(e, t, n))),
    ]),
  ...
  const wp = [or("selector"), yr("execute", bg), yr("moveOnTab", !1)],
    ...
    _p = x([
      lg(ng(Ym), Dg(Cp)),
      lg(ng(Zm), Dg(Op)),
      lg(rg([sg, ng(Gm)]), (e, t, o, n) => (o.moveOnTab ? Dg(Cp)(e, t, o, n) : A.none())),
      lg(rg([ig, ng(Gm)]), (e, t, o, n) => (o.moveOnTab ? Dg(Op)(e, t, o, n) : A.none())),
      lg(ng($m), Sp),
      lg(ng(Xm), Sp),
    ]),
    Tp = x([lg(ng(Xm), vg)]);
  ...
  const Dp = hg.schema(),
    ...
    Hp = Tl({
      branchKey: "mode",
      branches: Object.freeze({ __proto__: null, acyclic: Dp, cyclic: Bp, flow: Fp, flatgrid: Ip, matrix: Rp, execution: Np, menu: Vp, special: zp }),
      name: "keying",
  ...
  const Xp = Ol({ fields: [Cr("reuseDom", !0)], name: "replacing", apis: qp }),
    Kp = (e, t) => {
      const o = ((e, t) => {
        const o = Hs(t);
        return Ol({ fields: [or("enabled")], name: e, active: { events: x(o) } });
      })(e, t);
  ...
  const eh = Ol({ fields: Qp, name: "focusing", active: Zp, apis: Jp }),
    th = (e, t, o, n) => {
      const r = o.get();
      o.set(n),
        ((e, t, o) => {
  ...
  const ch = () => {
    ...
    xh = [
      ...
      Ri("builder", (e) => ({
        ...
        domModification: {
          ...e.domModification,
          attributes: { role: yh(e), ...e.domModification.attributes, "aria-haspopup": e.hasSubmenu, ...(e.hasSubmenu ? { "aria-expanded": !1 } : {}) },
        },
    ...
    Sh = x("item-widget"),
    kh = x([Lu({ name: "widget", overrides: (e) => ({ behaviours: kl([mu.config({ store: { mode: "manual", getValue: (t) => e.data, setValue: b } })]) }) })]),
    Ch = [
      or("uid"),
      or("data"),
      or("components"),
    ...
    Oh = Jn("type", { widget: Ch, item: xh, separator: wh }),
    _h = x([
      Wu({
        factory: {
          sketch: (e) => {
    ...
    Th = x([
      ...
      xr(
        ...
        Jn("mode", {
          ...
          menu: [yr("moveOnTab", !0), Ri("config", (e, t) => ({ mode: "menu", selector: "." + e.markers.item, moveOnTab: t.moveOnTab, focusManager: e.focusManager }))],
        })
      ),
      nr("markers", _i()),
      yr("fakeFocus", !1),
    ...
    Ah = hm({
      ...
      factory: (e, t, o, n) => ({
        ...
        behaviours: hu(e.menuBehaviours, [
          Wm.config({ highlightClass: e.markers.selectedItem, itemClass: e.markers.item, onHighlight: e.onHighlight, onDehighlight: e.onDehighlight }),
        ...
        getTriggeringPath: (t, r) => {
          ...
          return be(o.get(), t).bind((t) => {
            ...
            return ((e) => {
              ...
              X(o, (t, a) =>
                ((t, o, n) =>
                  s(t).bind((r) => ((t) => he(e.get(), (e, o) => e === t))(t).bind((e) => o(e).map((e) => ({ triggeredMenu: r, triggeringItem: e, triggeringPath: n })))))(
                  t,
                  r,
                  o.slice(0, a + 1)
                ).fold(
  ...
  const Vh = x("collapse-item"),
    ...
    Hh = pm({
      ...
      configFields: [
        ...
        vr("fireDismissalEventInstead", [yr("event", Cs())]),
        vr("fireRepositionEventInstead", [yr("event", Os())]),
      ...
      factory: (e, t) => {
        const o = (t, o, n, r) => {
            ...
            $d.openWhileCloaked(t, o, () => xd.positionWithinBounds(s, t, n, r())), mu.setValue(t, A.some({ mode: "position", config: n, getBounds: r }));
          },
          n = (t, o, n, r) => {
            const s = ((e, t, o, n, r) => {
        ...
        return {
          ...
          behaviours: hu(e.inlineBehaviours, [
            ...
            Al.config({
              channels: {
                ...Jd({ isExtraPart: t.isExtraPart, ...e.fireDismissalEventInstead.map((e) => ({ fireEventInstead: { event: e.event } })).getOr({}) }),
        ...
        const t = Uh({ dom: { tag: "p", innerHtml: e.translationProvider(e.text) }, behaviours: kl([Xp.config({})]) }),
          ...
          i = Uh(
            Ph.sketch({
              ...
              components: [Zh("close", { tag: "div", classes: ["tox-icon"], attributes: { "aria-label": e.translationProvider("Close") } }, e.iconProvider)],
              action: (t) => {
                e.onAction(t);
              },
            })
  ...
  const af = (e) => (t) => t.options.get(e),
    ...
    cf = (e) => {
      ...
      n("skin", { processor: (e) => s(e) || !1 === e, default: "oxide" }),
        ...
        n("toolbar", { processor: (e) => (d(e) || s(e) || l(e) ? { value: e, valid: !0 } : { valid: !1, message: "Must be a boolean, string or array." }), default: !0 }),
        V(9, (e) => {
  ...
  const mb = "tox-menu-nav__js",
    ...
    Eb = (e, t, o) => {
      const n = Cb(o);
      return { dom: { tag: "div", classes: q([[n.tieredMenu]]) }, markers: Ob(o) };
    },
    Ab = x([
      ur("data"),
      yr("inputAttributes", {}),
    ...
    Fb = pm({ name: "Input", configFields: Ab(), factory: (e, t) => ({ uid: e.uid, dom: Bb(e), components: [], behaviours: Db(e), eventOrder: e.eventOrder }) }),
    ...
    Pb = (e) => {
      var t;
      return e.dom
        ? { ...e, dom: { ...e.dom, attributes: { ...(null !== (t = e.dom.attributes) && void 0 !== t ? t : {}), id: la("aria-item-search-result-id"), "aria-selected": "false" } } }
        : e;
    },
    Ub = (e, t) => (o) => {
      const n = z(o, t);
    ...
    jb = (e, t, o) =>
      Ah.parts.items({
        preprocess: (n) => {
          const r = H(n, o);
          return "auto" !== e && e > 1 ? Ub({ tag: "div", classes: ["tox-collection__group"] }, e)(r) : Wb(r, (e, o) => "separator" === t[o].type);
        },
      }),
    Gb = (e, t, o = !0) => ({
              ...
              ? ((e, t, o) => {
                  ...
                  return {
                    ...
                    components: [
                      ...
                      { dom: { tag: "div", classes: [...(1 === e ? ["tox-collection--list"] : ["tox-collection--grid"]), Lb], attributes: { id: n } }, components: [jb(e, t, Pb)] },
                    ],
                  };
                })(n, o, r.searchMode)
              : ((e, t, o = !0) => {
                  const n = la("aria-controls-search-results");
                  return {
                    dom: { tag: "div", classes: ["tox-menu", "tox-collection", Lb].concat(1 === e ? ["tox-collection--list"] : ["tox-collection--grid"]), attributes: { id: n } },
    ...
    zv = Dn([Sv("contextform"), Or("initValue", x("")), mv, dr("commands", Vv), mr("launch", Jn("type", { contextformbutton: Rv, contextformtogglebutton: Nv }))].concat(Bv)),
  ...
  var ly = Object.freeze({
    ...
    dy = [
      ...
      yr("anchor", (e) => ({ type: "hotspot", hotspot: e, layouts: { onLtr: x([cl, ll, rl, al, sl, il]), onRtl: x([cl, ll, rl, al, sl, il]) } })),
      Di("onHide"),
      Di("onShow"),
    ],
    uy = Object.freeze({
  ...
  const my = Ol({ fields: dy, name: "tooltipping", active: cy, state: uy, apis: ly }),
    gy = "silver.readonly",
  ...
  const hy = (e, t) => {
    ...
    Oy = { [us()]: ["disabling", "alloy.base.behaviour", "toggling", "item-events"] },
    _y = we,
    Ty = (e, t, o, n) => {
      const r = Er(b);
      return {
        ...
        itemBehaviours: kl(
          [
            Kp("item-events", [Cy(e, o), Sy(e, r), ky(e, r)]),
    ...
    Fy = (e, t) => ({ dom: { tag: "div", classes: [bb] }, components: [{ dom: { tag: e.tag, styles: e.styles }, components: [ti(Wh.translate(t))] }] }),
  ...
  const mx = {},
    ...
    Ex = (e, t) =>
      t === yx && e.options.isSet("color_map_foreground")
        ? Cx("color_map_foreground")(e)
        : t === xx && e.options.isSet("color_map_background")
          ? Cx("color_map_background")(e)
          : Cx("color_map")(e),
    ...
    Ix = (e, t, o) => e.concat(((e) => H(gx(e).state(), (e) => ({ type: "choiceitem", text: e, icon: "checkmark", value: e })))(t).concat(Bx(o))),
    Rx = (e, t, o) => (n) => {
      n(Ix(e, t, o));
    },
    Nx = (e, t, o) => {
    ...
    Kx = {
      inserttable: (e) => {
        const t = la("size-label"),
          ...
          n = Xx(0, 0),
          r = Uh({ dom: { tag: "span", classes: ["tox-insert-table-picker__label"], attributes: { id: t } }, components: [n], behaviours: kl([Xp.config({})]) });
        return {
          type: "widget",
      ...
      colorswatch: (e, t) => {
        ...
        return { type: "widget", data: { value: la("widget-id") }, dom: { tag: "div", classes: ["tox-fancymenuitem"] }, autofocus: !0, components: [Py.widget(Ah.sketch(s))] };
      },
    },
    Yx = (e) => ({ type: "separator", dom: { tag: "div", classes: [gb, "tox-collection__group-heading"] }, components: e.text.map(ti).toArray() });
  var Jx = Object.freeze({ __proto__: null, getCoupled: (e, t, o, n) => o.getOrCreate(e, t, n), getExistingCoupled: (e, t, o, n) => o.getExisting(e, t, n) }),
  ...
  const ew = Ol({ fields: Zx, name: "coupling", apis: Jx, state: Qx }),
    tw = (e) => {
      let t = A.none(),
        o = [];
      const n = (e) => {
    ...
    iw = x("sink"),
    lw = x(Uu({ name: iw(), overrides: x({ dom: { tag: "div" }, behaviours: kl([xd.config({ useFixed: E })]), events: Hs([qs(Yr()), qs(Wr()), qs(es())]) }) })),
    cw = (e, t) => {
          ...
          switch (e.type) {
            ...
            case "cardmenuitem":
              return ((e) => qn("cardmenuitem", qv, e))(e).fold(qb, (e) =>
                A.some(
                  ((e, t, o, n) => {
                    const r = { dom: Ny(e.label), optComponents: [A.some({ dom: { tag: "div", classes: [xb, wb] }, components: Ly(e.items, n) })] };
                    return Ty(
                      {
            ...
            default:
              return ((e) => qn("Autocompleter.Item", Ov, e))(e).fold(qb, (e) =>
                A.some(
                  ((e, t, o, n, r, s, a, i = !0) => {
                    const l = Vy(
                      {
                    ...
                    return Ty(
                      { data: Ey(e), enabled: e.enabled, getApi: x({}), onAction: (t) => r(e.value, e.meta), onSetup: x(b), triggersSubmenu: !1, itemBehaviours: zy(e.meta, a) },
                      l,
                      s,
                      a.providers
                    );
                  ...
                  Hh.showMenuAt(
                    ...
                    ((e, t, o, n) => {
                      ...
                      return {
                        ...
                        menu: { markers: Ob(n), fakeFocus: o === Cw.ContentFocus },
                      };
                    })(Kb("autocompleter-value", !0, o, s, { menuType: "normal" }), s, Cw.ContentFocus, "normal")
                  );
                }),
      ...
      const o = { stopBackspace: !0, ...t },
        ...
        i = tc(e, "keydown", (e) => {
          o.triggerEvent("keydown", e)
            ? e.kill()
            : o.stopBackspace && ((e) => e.raw.which === jm[0] && !R(["input", "textarea"], Ue(e.target)) && !Iw(e.target, '[contenteditable="true"]'))(e) && e.prevent();
        }),
        l = tc(e, "focusin", (e) => {
  ...
  const Jw = Ol({ fields: Yw, name: "tabstopping", active: Kw });
  ...
  var vS = Object.freeze({
    ...
    xS = [
      or("invalidClass"),
      yr("getRoot", A.none),
      vr("notify", [yr("aria", "alert"), yr("getContainer", A.none), yr("validHtml", ""), Di("onValid"), Di("onInvalid"), Di("onValidate")]),
  ...
  const wS = Ol({
    ...
    SS = Ol({
      ...
      active: Object.freeze({
        ...
        events: () => Hs([Ls(rs(), E)]),
        exhibit: () =>
          Ea({ styles: { "-webkit-user-select": "none", "user-select": "none", "-ms-user-select": "none", "-moz-user-select": "-moz-none" }, attributes: { unselectable: "on" } }),
      }),
    }),
  ...
  var RS = [
    ...
    Lu({
      ...
      overrides: (e) => {
        ...
        return {
          behaviours: kl([
            Hp.config({ mode: "special", onLeft: (o) => t.onLeft(o, e), onRight: (o) => t.onRight(o, e), onUp: (o) => t.onUp(o, e), onDown: (o) => t.onDown(o, e) }),
            eh.config({}),
          ]),
          events: Hs([
            Us(Hr(), o),
  ...
  const rC = hm({
    ...
    mC = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = [];
            return { field: (t, o) => (e.push(t), Ku(lC, dC(t), o)), record: x(e) };
          })(),
          o = e(t),
          n = t.record(),
          r = H(n, (e) => Lu({ name: e, pname: dC(e) }));
      ...
      const r = (o, n) =>
          wS.config({
            ...
            notify: {
              ...
              onValid: (e) => {
                Is(e, gC, { type: o, value: mu.getValue(e) });
              },
              onInvalid: (e) => {
                Is(e, pC, { type: o, value: mu.getValue(e) });
              },
            },
            validator: {
              validate: (t) => {
        ...
        i = Uh({ dom: { tag: "div", classes: [t("rgba-preview")], styles: { "background-color": "white" }, attributes: { role: "presentation" } } }),
        l = (e, t) => {
          i.getOpt(e).each((e) => {
        ...
        c = pm({
          factory: () => {
            const r = { red: Er(A.some(255)), green: Er(A.some(255)), blue: Er(A.some(255)), hex: Er(A.some("ffffff")) },
              ...
              p = (t) => ({ label: e(fC + t + ".label"), description: e(fC + t + ".description") }),
              h = p("red"),
              f = p("green"),
              b = p("blue"),
              v = p("hex");
            return fn(
              mC.sketch((o) => ({
                ...
                formBehaviours: kl([wS.config({ invalidClass: t("form-invalid") }), Kp("rgb-form-events", [Us(gC, g), Us(pC, m), Us(hC, m)])]),
              })),
              {
                apis: {
                  updateHex: (e, t) => {
      ...
      const o = pm({
        ...
        factory: (o) => {
          const n = bC(e, t, o.onValidHex, o.onInvalidHex),
            r = ((e, t) => {
              const o = rC.parts.spectrum({ dom: { tag: "canvas", attributes: { role: "presentation" }, classes: [t("sv-palette-spectrum")] } }),
                n = rC.parts.thumb({
                  dom: {
                    tag: "div",
              ...
              return pm({
                ...
                apis: {
                  ...
                  setThumb: (e, t, o) => {
                    ((e, t) => {
                      const o = fx(nx(t));
                      rC.setValue(e, { x: o.saturation, y: 100 - o.value });
                    })(t, o);
                  },
                },
                extraApis: {},
            ...
            a = Uh(
              ((e, t) => {
                const o = rC.parts.spectrum({ dom: { tag: "div", classes: [t("hue-slider-spectrum")], attributes: { role: "presentation" } } }),
                  n = rC.parts.thumb({ dom: { tag: "div", classes: [t("hue-slider-thumb")], attributes: { role: "presentation" } } });
                return rC.sketch({
    ...
    yC = () => ym.config({ find: A.some }),
    xC = (e) => ym.config({ find: (t) => lt(t.element, e).bind((e) => t.getSystem().getByDom(e).toOptional()) }),
    wC = Dn([yr("preprocess", w), yr("postprocess", w)]),
    SC = (e, t, o) => mu.config({ store: { mode: "manual", ...e.map((e) => ({ initialValue: e })).getOr({}), getValue: t, setValue: o } }),
    kC = (e, t, o) =>
      SC(
        e,
        (e) => t(e.element),
    ...
    OC = kC,
    _C = SC,
    TC = (e) => mu.config({ store: { mode: "memory", initialValue: e } }),
    EC = {
  ...
  const DC = la("alloy-fake-before-tabstop"),
    ...
    IC = (e) => ({ dom: { tag: "div", classes: ["tox-navobj"] }, components: [FC([DC]), e, FC([BC])], behaviours: kl([xC(1)]) }),
    RC = (e, t) => {
    ...
    UC = (e, t, o) => Zh(e, { tag: "span", classes: ["tox-icon", "tox-tbtn__icon-wrap"], behaviours: o }, t),
    WC = (e, t) => UC(e, t, []),
    jC = (e, t) => UC(e, t, [Xp.config({})]),
    GC = (e, t, o) => ({ dom: { tag: "span", classes: [`${t}__select-label`] }, components: [ti(o.translate(e))], behaviours: kl([Xp.config({})]) }),
    ...
    aO = x([
      ...
      Lu({
        ...
        schema: [or("dom")],
        name: "lock",
        overrides: (e) => ({ buttonBehaviours: kl([lh.config({ selected: e.locked, toggleClass: e.markers.lockClass, aria: { mode: "pressed" } })]) }),
      }),
    ]),
    iO = hm({
    ...
    uO = (e, t) => {
      const o = e.label.map((e) => oS(e, t)),
        n = [
          ...
          by(),
          Hp.config({ mode: "execution", useEnter: !0 !== e.multiline, useControlEnter: !0 === e.multiline, execute: (e) => (Fs(e, iS), A.some(!0)) }),
          Kp("textfield-change", [
            Us(Zr(), (t, o) => {
              Is(t, nS, { name: e.name });
            }),
  ...
  var CO = Object.freeze({
    ...
    _O = [
      ...
      nr(
        "dimension",
        Jn("property", { width: [Ri("property", "width"), Ri("getDimension", (e) => Jt(e) + "px")], height: [Ri("property", "height"), Ri("getDimension", (e) => Wt(e) + "px")] })
      ),
    ];
  const TO = Ol({
      fields: _O,
      ...
      XC(
        {
          ...
          fetch: (t, n) => {
            ...
            e.fetch(
              (t) => {
                n(ZC(t, ub.CLOSE_ON_EXECUTE, o, { isHorizontalMenu: !1, search: e.search }));
              },
              r,
              EO(t)
            );
    ...
    DO = (e) => ({ dom: { tag: "span", classes: ["tox-tree__label"], attributes: { title: e, "aria-label": e } }, components: [ti(e)] }),
    BO = la("leaf-label-event-id"),
    FO = ({ leaf: e, onLeafAction: t, visible: o, treeId: n, backstage: r }) => {
    ...
    RO = ({ directory: e, visible: t, noChildren: o, backstage: n }) => {
      const r = e.menu.map((e) => AO(e, "tox-mbtn", n, A.none())),
        s = [
          {
            dom: { tag: "div", classes: ["tox-chevron"] },
            components: [
              ((a = "chevron-right"), (i = n.shared.providers.icons), ((e, t, o) => Zh(e, { tag: "span", classes: ["tox-tree__icon-wrap", "tox-icon"], behaviours: [] }, t))(a, i)),
            ],
          },
          DO(e.title),
        ];
    ...
    NO = ({ children: e, onLeafAction: t, visible: o, treeId: n, backstage: r }) => ({
      dom: { tag: "div", classes: ["tox-tree--directory__children"] },
      components: e.map((e) =>
        "leaf" === e.type
          ? FO({ leaf: e, onLeafAction: t, visible: o, treeId: n, backstage: r })
          : VO({ directory: e, onLeafAction: t, labelTabstopping: o, treeId: n, backstage: r })
      ),
      behaviours: kl([
        TO.config({
    ...
    VO = ({ directory: e, onLeafAction: t, labelTabstopping: o, treeId: n, backstage: r }) => {
      ...
      return {
        ...
        components: [
          RO({ directory: e, visible: o, noChildren: 0 === e.children.length, backstage: r }),
          NO({ children: s, onLeafAction: t, visible: !1, treeId: n, backstage: r }),
        ],
        behaviours: kl([
          lh.config({
            ...
            onToggled: (e, o) => {
              const a = e.components()[1],
                i =
                  ...
                  s.map((e) =>
                    "leaf" === e.type
                      ? FO({ leaf: e, onLeafAction: t, visible: l, treeId: n, backstage: r })
                      : VO({ directory: e, onLeafAction: t, labelTabstopping: l, treeId: n, backstage: r })
                  ));
              var l;
  ...
  var PO = Object.freeze({ __proto__: null, throttle: LO, init: (e) => e.stream.streams.state(e) }),
    UO = [
      nr(
        "stream",
        Jn("mode", {
  ...
  const WO = Ol({ fields: UO, name: "streaming", active: zO, state: PO }),
    jO = (e, t, o) => {
    ...
    XO = x(
      [
        ...
        yr("layouts", A.none()),
        yr("eventOrder", {}),
        Tr("model", {}, [yr("getDisplayText", (e) => (void 0 !== e.meta && void 0 !== e.meta.text ? e.meta.text : e.value)), yr("selectsOver", !0), yr("populateFromBrowse", !0)]),
        Di("onSetValue"),
        Bi("onExecute"),
        Di("onItemExecute"),
        yr("inputClasses", []),
        ...
        Ai(["openClass"]),
        ur("initialData"),
        gu("typeaheadBehaviours", [eh, mu, WO, Hp, lh, ew]),
    ...
    KO = x([
      Pu({
        ...
        overrides: (e) => ({
          ...
          onExecute: (t, o) => e.lazyTypeaheadComp.get().map((e) => (Is(e, qO(), { item: o }), !0)),
          onHover: (t, o) => {
            e.previewing.set(!1),
              e.lazyTypeaheadComp.get().each((t) => {
    ...
    YO = hm({
      ...
      factory: (e, t, o, n) => {
        const r = (t, o, r) => {
          ...
          d = { [ks()]: [mu.name(), WO.name(), l], ...e.eventOrder };
        return {
          uid: e.uid,
    ...
    e_ = (e, t, o, n = []) => {
      const r = { tag: "button", classes: ["tox-tbtn"], attributes: e.tooltip.map((e) => ({ "aria-label": o.translate(e), title: o.translate(e) })).getOr({}) },
    ...
    o_ = (e, t, o, n = [], r = []) => {
      ...
      return QO(e, t, n, { tag: "button", classes: c, attributes: { title: s } }, i, o);
    },
    n_ = (e, t, o, n = [], r = []) => {
    ...
    r_ = (e, t) => (o) => {
      "custom" === t ? Is(o, aS, { name: e, value: {} }) : "submit" === t ? Fs(o, iS) : "cancel" === t ? Fs(o, sS) : console.error("Unknown button type: ", t);
    },
    s_ = (e, t, o) => {
      if (((e, t) => "menu" === t)(0, t)) {
        const t = () => s,
          n = e,
          r = { ...e, type: "menubutton", search: A.none(), onSetup: (t) => (t.setEnabled(e.enabled), b), fetch: MO(n.items, t, o) },
    ...
    y_ = {
      bar: v_((e, t) => ((e, t) => ({ dom: { tag: "div", classes: ["tox-bar", "tox-form__controls-h-stack"] }, components: H(e.items, t.interpreter) }))(e, t.shared)),
      collection: v_((e, t, o) =>
        ((e, t, o) => {
                  ...
                  onSetValue: (o, n) => {
                    ((o, n) => {
                      const r = H(n, (o) => {
                          ...
                          return `<div class="tox-collection__item${t.isDisabled() ? " tox-collection__item--state-disabled" : ""}" tabindex="-1" data-collection-item-value="${Zw.encodeAllRaw(
                            o.value
      ...
      label: v_((e, t) =>
        ((e, t) => {
          return {
            ...
            components: [{ dom: { tag: "label", classes: ["tox-label"] }, components: [ti(t.providers.translate(e.label))] }, ...H(e.items, t.interpreter)],
            behaviours: kl([yC(), Xp.config({}), ((o = A.none()), kC(o, ea, ta)), Hp.config({ mode: "acyclic" })]),
          };
          var o;
        })(e, t.shared)
      ),
      ...
      button: v_((e, t) =>
        ((e, t) => {
          ...
          return (n = A.none()), (r = Xw.parts.field({ factory: Ph, ...o_(e, A.some(o), t, [TC(""), yC()]) })), Qw(n, r, [], []);
          var n, r;
        })(e, t.shared.providers)
      ),
      checkbox: v_((e, t, o) =>
        ((e, t, o) => {
          const n = (e) => (e.element.dom.click(), A.some(!0)),
            ...
            s = Xw.parts.label({ dom: { tag: "span", classes: ["tox-checkbox__label"] }, components: [ti(t.translate(e.label))], behaviours: kl([SS.config({})]) }),
            a = (e) => Zh("checked" === e ? "selected" : "unselected", { tag: "span", classes: ["tox-icon", "tox-checkbox-icon__" + e] }, t.icons),
      ...
      grid: v_((e, t) => ((e, t) => ({ dom: { tag: "div", classes: ["tox-form__grid", `tox-form__grid--${e.columns}col`] }, components: H(e.items, t.interpreter) }))(e, t.shared)),
      listbox: v_((e, t, o) =>
        ((e, t, o) => {
                  ...
                  XC(
                    {
                      ...
                      fetch: (o, n) => {
                        ...
                        n(ZC(r, ub.CLOSE_ON_EXECUTE, t, { isHorizontalMenu: !1, search: A.none() }));
                      },
                      onSetup: x(b),
                      getApi: x({}),
                      columns: 1,
                      ...
                      dropdownBehaviours: [
                        ...
                        _C(
                          ...
                          (t, o) => {
                            oO(e.items, o).each((e) => {
                              kt(t.element, eO, e.value), Is(t, $C, { text: e.text });
                            });
                          }
                        ),
                      ],
                  ...
                  o = ((e, t) => {
                    ...
                    return Se(o, n, (e, t) =>
                      cO(e, t.unit)
                        .map((e) => t.value / e)
                        .map((e) => {
                          return (o = e), (n = t.unit), (e) => cO(e, n).map((e) => ({ value: e * o, unit: n }));
                          var o, n;
                        })
                        .getOr(dO)
                    ).getOr(dO);
      ...
      slider: v_((e, t, o) =>
        ((e, t, o) => {
          const n = rC.parts.label({ dom: { tag: "label", classes: ["tox-label"] }, components: [ti(t.translate(e.label))] }),
            r = rC.parts.spectrum({ dom: { tag: "div", classes: ["tox-slider__rail"], attributes: { role: "presentation" } } }),
            s = rC.parts.thumb({ dom: { tag: "div", classes: ["tox-slider__handle"], attributes: { role: "presentation" } } });
          return rC.sketch({
      ...
      urlinput: v_((e, t, o) =>
        ((e, t, o, n) => {
          const r = t.shared.providers,
                ...
                const r = ((e, t, o) => {
                    ...
                    return o.getLinkInformation().fold(
                      ...
                      (t) => {
                        ...
                        return "file" === e
                          ? ((s = [n, p_(r, d_(t)), p_(r, q([m_(t), u_(t), g_(t)]))]), j(s, (e, t) => (0 === e.length || 0 === t.length ? e.concat(t) : e.concat(a_, t)), []))
                          : n;
                        var s;
                      }
                    );
                  })(e.filetype, n, o),
                  s = ZC(r, ub.BUBBLE_TO_SANDBOX, t, { isHorizontalMenu: !1, search: A.none() });
                return aw(s);
              },
            ...
            p = Uh(
              n_(
                { name: e.name, icon: A.some("browse"), text: e.label.getOr(""), enabled: e.enabled, primary: !1, buttonType: A.none(), borderless: !0 },
                (e) => Fs(e, m),
                r,
                [],
                ["tox-browse-url"]
      ...
      imagepreview: v_((e, t, o) =>
        ((e, t) => {
          const o = Er(t.getOr({ url: "" })),
            ...
            r = Uh({ dom: { tag: "div", classes: ["tox-imagepreview__container"], attributes: { role: "presentation" } }, components: [n.asSpec()] }),
            s = {};
                  ...
                  const a = () => {
                    ...
                    if (!u(t) && !u(o)) {
                      ...
                      const a = ((e, t, o, n, r) => {
                        ...
                        return { left: i.toString() + "px", top: l.toString() + "px", width: s.toString() + "px", height: a.toString() + "px" };
                  ...
                  n.getOpt(e).each((o) => {
                    ...
                    t.url !== Ot(n, "src") && (kt(n, "src", t.url), Pa(e.element, "tox-imagepreview__loaded")),
                      ...
                      new Promise((e, t) => {
                        ...
                        e.getSystem().isConnected() &&
                          (La(e.element, "tox-imagepreview__loaded"), (s.cachedWidth = t.dom.naturalWidth), (s.cachedHeight = t.dom.naturalHeight), a());
                      });
                  });
                }
              ),
      ...
      table: v_((e, t) =>
        ((e, t) => {
          ...
          return {
            ...
            components: [
              ((r = e.header), { dom: { tag: "thead" }, components: [{ dom: { tag: "tr" }, components: H(r, (e) => ({ dom: { tag: "th", innerHtml: t.translate(e) } })) }] }),
        ...
        ((e, t) => {
          ...
          return {
            ...
            components: e.items.map((e) =>
              "leaf" === e.type
                ? FO({ leaf: e, onLeafAction: o, visible: !0, treeId: n, backstage: t })
                : VO({ directory: e, onLeafAction: o, labelTabstopping: !0, treeId: n, backstage: t })
            ),
            behaviours: kl([Hp.config({ mode: "flow", selector: ".tox-tree--leaf__label--visible, .tox-tree--directory__label--visible", cycles: !1 })]),
          };
        })(e, t)
      ),
    ...
    D_ = (e, t, o) => zi(T_(e, t), A_(e, t), o.insetSouthwest(), Wi(), "southwest", Yi(e, { right: 0, bottom: 3 }), C_),
    B_ = (e, t, o) => zi(O_(e), A_(e, t), o.insetSoutheast(), Ui(), "southeast", Yi(e, { left: 1, bottom: 3 }), C_),
    F_ = (e, t, o) => zi(T_(e, t), E_(e), o.insetNorthwest(), Pi(), "northwest", Yi(e, { right: 0, top: 2 }), C_),
    I_ = (e, t, o) => zi(O_(e), E_(e), o.insetNortheast(), Li(), "northeast", Yi(e, { left: 1, top: 2 }), C_),
    R_ = (e, t, o) => zi(__(e, t), E_(e), o.insetNorth(), ji(), "north", Yi(e, { top: 2 }), C_),
    N_ = (e, t, o) => zi(__(e, t), A_(e, t), o.insetSouth(), Gi(), "south", Yi(e, { bottom: 3 }), C_),
    V_ = (e, t, o) => zi(T_(e, t), M_(e, t), o.insetEast(), qi(), "east", Yi(e, { right: 0 }), C_),
    z_ = (e, t, o) => zi(O_(e), M_(e, t), o.insetWest(), $i(), "west", Yi(e, { left: 1 }), C_),
    H_ = (e) => {
      switch (e) {
        case "north":
          return R_;
    ...
    j_ = (e, t, o) => {
      ...
      return () =>
        o()
          ? { type: "node", root: ft(ht(e())), node: A.from(e()), bubble: gc(12, 12, W_), layouts: { onRtl: () => [I_], onLtr: () => [F_] }, overrides: n }
          : { type: "hotspot", hotspot: t(), bubble: gc(-12, 12, W_), layouts: { onRtl: () => [rl, sl, cl], onLtr: () => [sl, rl, cl] }, overrides: n };
    },
    G_ = (e, t, o) => () =>
      o()
    ...
    DT = (e) => ({
      getHistory: OT,
      addToHistory: _T,
      getLinkInformation: () => ((e) => (Rf(e) ? A.some({ targets: xT(e.getBody()), anchorTop: MT(Nf(e)), anchorBottom: MT(Vf(e)) }) : A.none()))(e),
  ...
  var hE = Object.freeze({
    ...
    bE = [
      vr("contextual", [sr("fadeInClass"), sr("fadeOutClass"), sr("transitionClass"), ir("lazyContext"), Di("onShow"), Di("onShown"), Di("onHide"), Di("onHidden")]),
      Or("lazyViewport", () => ({ bounds: en(), optScrollEnv: A.none() })),
  ...
  const vE = Ol({
    ...
    TE = (e, t) => {
      const o = Ql(),
        ...
        a = e.inline ? [] : [Al.config({ channels: { [yE()]: { onReceive: CE } } })];
      return [
        eh.config({}),
        vE.config({
          contextual: {
  ...
  const RE = "container",
    ...
    jE = (e) => LE.sketch((t) => ({ dom: { tag: "div", classes: ["tox-sidebar__pane-container"] }, components: WE(t, e), slotBehaviours: ny([Ys((e) => LE.hideAllSlots(e))]) })),
    GE = (e, t) => {
      kt(e, "role", t);
    },
  ...
  const JE = Ol({
    ...
    lA = x([Lu({ factory: LT, schema: zT(), name: "primary" }), Pu({ schema: zT(), name: "overflow" }), Pu({ name: "overflow-button" }), Pu({ name: "overflow-group" })]),
    cA = x((e, t) => {
      ((e, t) => {
    ...
    uA = x([
      Pu({
        ...
        overrides: (e) => ({
          ...
          buttonBehaviours: kl([lh.config({ toggleClass: e.markers.toggledClass, aria: { mode: "expanded" }, toggleOnExecute: !1, onToggled: e.onToggled })]),
        }),
      }),
      Pu({
        factory: LT,
        schema: zT(),
        name: "toolbar",
        overrides: (e) => ({ toolbarBehaviours: kl([Hp.config({ mode: "cyclic", onEscape: (t) => (em(t, e, "button").each(eh.focus), A.none()) })]) }),
      }),
    ]),
    mA = Ql(),
    gA = (e, t) => {
                  ...
                  ((e, t, o) => {
                    ...
                    return {
                      ...
                      behaviours: kl([
                        ...
                        Al.config({
                          channels: {
                            ...Jd({ isExtraPart: T, ...o.fireDismissalEventInstead.map((e) => ({ fireEventInstead: { event: e.event } })).getOr({}) }),
                            ...Qd({
                              doReposition: () => {
    ...
    SA = hm({
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          dom: e.dom,
          components: t,
          behaviours: hu(e.splitToolbarBehaviours, [ew.config({ others: { overflowGroup: () => yA.sketch({ ...n["overflow-group"](), items: [r.asSpec()] }) } })]),
          apis: {
            setGroups: (t, o) => {
    ...
    CA = x([
      ...
      Pu({
        ...
        overrides: (e) => ({ buttonBehaviours: kl([lh.config({ toggleClass: e.markers.overflowToggledClass, aria: { mode: "pressed" }, toggleOnExecute: !1 })]) }),
      }),
    ...
    MA = (e, t) => {
      ...
      return kl([xy(e.providers.isDisabled), by(), Hp.config({ mode: t, onEscape: e.onEscape, selector: ".tox-toolbar__group" }), Kp("toolbar-events", [o])]);
    },
    DA = (e) => {
      ...
      return {
        ...
        parts: {
          ...
          "overflow-button": e_(
            { name: "more", icon: A.some("more-drawer"), enabled: !0, tooltip: A.some("More..."), primary: !1, buttonType: A.none(), borderless: !1 },
            A.none(),
            e.providers
          ),
        },
    ...
    NA = { button: [...RA, Qb, ar("type", ["button"])], togglebutton: [...RA, Cr("active", !1), ar("type", ["togglebutton"])] },
        ...
        factory: {
          sketch: (e) => {
            ...
            const o = H(e.buttons, (o) =>
              "group" === o.type
                ? ((t = !0), ((e, t) => ({ dom: { tag: "div", classes: ["tox-view__toolbar__group"] }, components: H(e.buttons, (e) => LA(e, t)) }))(o, e.providers))
                : LA(o, e.providers)
            );
            return {
              uid: e.uid,
              dom: { tag: "div", classes: [t ? "tox-view__toolbar" : "tox-view__header", ...(UA || WA ? ["tox-view--mobile", "tox-view--scrolling"] : [])] },
              behaviours: kl([eh.config({}), Hp.config({ mode: "flow", selector: "button, .tox-button", focusInside: mg.OnEnterOrSpaceMode })]),
              components: t
                ? o
                : [
  ...
  const GA = (e, t, o) =>
    ...
    $A = (e, t) =>
      LE.sketch((o) => ({ dom: { tag: "div", classes: ["tox-view-wrap__slot-container"] }, components: GA(o, e, t), slotBehaviours: ny([Ys((e) => LE.hideAllSlots(e))]) })),
  ...
  var KA = pm({
    ...
    apis: { setViews: (e, t, o) => e.setViews(t, o), toggleView: (e, t, o, n, r) => e.toggleView(t, o, n, r), whichView: (e, t) => e.whichView(t) },
  });
      ...
      factory: {
        sketch: (e) =>
          VT.sketch({
            ...
            makeItem: () =>
              IA({ type: e.type, uid: la("multiple-toolbar-item"), cyclicKeying: !1, initGroups: [], providers: e.providers, onEscape: () => (e.onEscape(), A.some(!0)) }),
            setupItem: (e, t, o, n) => {
              LT.setGroups(t, o);
            },
            shell: !0,
            ...
            ((e, t) => {
              ym.getCurrent(e).each((o) => {
                ym.getCurrent(o).each((n) => {
                  TO.hasGrown(o)
                    ? LE.isShowing(n, t)
                      ? (TO.shrink(o), GE(e.element, "presentation"))
                      : (LE.hideAllSlots(n), LE.showSlot(n, t), GE(e.element, "region"))
                    : (LE.hideAllSlots(n), LE.showSlot(n, t), TO.grow(o), GE(e.element, "region"));
                });
              });
            })(e, o)
          );
    ...
    wM = (e, t, o) => {
      const n = (e, n, s, a) => {
          ...
          if ("submenu" === e.type) {
            ...
            return 0 === n && t.length <= 0
              ? A.none()
              : A.some({ type: "nestedmenuitem", text: i, enabled: t.length > 0, getSubmenuItems: () => X(e.getStyleItems(), (e) => r(e, n, a)) });
          }
          return A.some({
            type: "togglemenuitem",
            text: i,
      ...
      return {
        ...
        getFetch: (e, t) => (o, n) => {
          const r = t(),
            a = s(r);
          n(ZC(a, ub.CLOSE_ON_EXECUTE, e, { isHorizontalMenu: !1, search: A.none() }));
        },
      };
    },
    SM = (e, t, o) => {
  ...
  const OM = (e, t, o) => {
      const n =
        ((r = ((e, t) => (t === CM.SemiColon ? e.replace(/;$/, "").split(";") : e.split(" ")))(e.options.get(t), o)),
        H(r, (e) => {
          let t = e,
            o = e;
          const n = e.split("=");
    ...
    NM = (e, t) =>
      A.from(RM.exec(e)).bind((e) => {
        const o = Number(e[1]),
          n = e[2];
        return ((e, t) => N(t, (t) => N(IM[t], (t) => e === t)))(n, t) ? A.some({ value: o, unit: n }) : A.none();
      }),
    ...
    UM = (e) => {
      var t;
      return null !== (t = { em: { step: 0.1 }, cm: { step: 0.1 }, in: { step: 0.1 }, pc: { step: 0.1 }, ch: { step: 0.1 }, rem: { step: 0.1 } }[e]) && void 0 !== t
        ? t
        : { step: 1 };
    },
    WM = (e, t) => {
    ...
    KM = (e) => ({ isEnabled: () => !Fm.isDisabled(e), setEnabled: (t) => Fm.set(e, !t), setText: (t) => Is(e, $C, { text: t }), setIcon: (t) => Is(e, qC, { icon: t }) }),
    YM = (e) => ({
      setActive: (t) => {
        lh.set(e, t);
      },
      ...
      isEnabled: () => !Fm.isDisabled(e),
      setEnabled: (t) => Fm.set(e, !t),
      setText: (t) => Is(e, $C, { text: t }),
      setIcon: (t) => Is(e, qC, { icon: t }),
    }),
    JM = (e, t) => e.map((e) => ({ "aria-label": t.translate(e), title: t.translate(e) })).getOr({}),
    ZM = la("focus-button"),
    QM = (e, t, o, n, r) => {
      const s = t.map((e) => Uh(GC(e, "tox-tbtn", r))),
        a = e.map((e) => Uh(jC(e, r.icons)));
      return {
        dom: { tag: "button", classes: ["tox-tbtn"].concat(t.isSome() ? ["tox-tbtn--select"] : []), attributes: JM(o, r) },
        components: _y([a.map((e) => e.asSpec()), s.map((e) => e.asSpec())]),
        eventOrder: { [Wr()]: ["focusing", "alloy.base.behaviour", HC], [Ss()]: [HC, "toolbar-group-button-events"] },
        buttonBehaviours: kl(
          [
            xy(r.isDisabled),
            by(),
              ...
              Kp("toolbar-button-events", [
                ...
                Qs((e, t) => {
                  wy(
                    ...
                    Is(e, zC, { buttonApi: t }), a.onAction(t);
                  });
                })),
                Sy(t, r),
                ky(t, r),
    ...
    tD = (e, t, o) => eD(e, { toolbarButtonBehaviours: o.length > 0 ? [Kp("toolbarButtonWith", o)] : [], getApi: KM, onSetup: e.onSetup }, t),
    oD = (e, t, o) =>
      eD(
        e,
        {
          toolbarButtonBehaviours: [Xp.config({}), lh.config({ toggleClass: "tox-tbtn--enabled", aria: { mode: "pressed" }, toggleOnExecute: !1 })].concat(
            o.length > 0 ? [Kp("toolbarToggleButtonWith", o)] : []
          ),
          getApi: YM,
          onSetup: e.onSetup,
        },
                ...
                setIcon: (t) =>
                  pi(e.element, "span").each((o) =>
                    e
                      .getSystem()
                      .getByDom(o)
                      .each((e) => Is(e, qC, { icon: t }))
                  ),
              }),
              n = Er(b),
              r = { getApi: o, onSetup: e.onSetup };
            return XM.sketch({
              dom: { tag: "div", classes: ["tox-split-button"], attributes: { "aria-pressed": !1, ...JM(e.tooltip, t.providers) } },
              onExecute: (t) => {
                const n = o(t);
              ...
              splitDropdownBehaviours: kl([
                ...
                by(),
                Kp("split-dropdown-events", [Ys((e, t) => PC(e)), Us(ZM, eh.focus), Sy(r, n), ky(r, n)]),
                SS.config({}),
              ]),
              ...
              components: [
                XM.parts.button(QM(e.icon, e.text, A.none(), A.some([lh.config({ toggleClass: "tox-tbtn--enabled", toggleOnExecute: !1 })]), t.providers)),
                XM.parts.arrow({
                  dom: { tag: "button", classes: ["tox-tbtn", "tox-split-button__chevron"], innerHtml: Kh("chevron-down", t.providers.icons) },
                  buttonBehaviours: kl([yy(t.providers.isDisabled), by(), Yh()]),
                }),
                XM.parts["aria-descriptor"]({ text: t.providers.translate("To open the popup, press Shift+Enter") }),
              ],
            });
          })(e, t.shared)
      ),
      grouptoolbarbutton: sD(
        ...
        (e, t, o) => {
          ...
          if (Sf(o) === tf.floating)
            return ((e, t, o, n) => {
              const r = t.shared,
                s = Er(b),
                a = { toolbarButtonBehaviours: [], getApi: KM, onSetup: e.onSetup },
              ...
              return fA.sketch({
                ...
                parts: { button: QM(e.icon, e.text, e.tooltip, A.some(i), r.providers), toolbar: { dom: { tag: "div", classes: ["tox-toolbar__overflow"], attributes: n } } },
              });
            })(e, t, (e) => lD(o, { buttons: n, toolbar: e, allowToolbarGroups: !1 }, t, A.none()), r);
    ...
    iD = {
      ...
      fontsizeinput: (e, t) =>
        ((e, t, o) => {
          ...
          t,
          ((e) => ({
            updateInputValue: (t) => Is(t, $C, { text: e.queryCommandValue("FontSize") }),
            ...
            0 === r.trim().length
              ...
              : ((e, t, o, n, r, s) =>
                  be(t, o.toLowerCase())
                    ...
                    .fold(
                      () => be(iD, o.toLowerCase()).map((t) => t(e, r)),
                      (t) =>
                        "grouptoolbarbutton" !== t.type || n
                          ...
                          : (console.warn(`Ignoring the '${o}' toolbar button. Group toolbar buttons are only supported when using floating toolbar mode and cannot be nested.`),
                            A.none())
  ...
  const gD = (e) => (/^[0-9\.]+(|px)$/i.test("" + e) ? A.some(parseInt("" + e, 10)) : A.none()),
    ...
    { ToolbarLocation: bD, ToolbarMode: vD } = ib,
    yD = (e, t, o, n, r) => {
        ...
        sb(e) ? (Fd(i, s.mothership), Fd(i, t.popupUi.mothership)) : Bd(r, s.mothership),
          ...
          ((e, t, o, n) => {
            const r = Er(xD(t, o.isPositionedAtTop())),
              s = (n) => {
                const { pos: s, bounds: a } = xD(t, o.isPositionedAtTop()),
                  { pos: i, bounds: l } = r.get(),
                  c = a.height !== l.height || a.width !== l.width;
                r.set({ pos: s, bounds: a }), c && lx(e, n), o.isVisible() && (i !== s ? o.update(vE.reset) : c && (o.updateMode(), o.repositionPopups()));
              };
  ...
  const SD = "contexttoolbar-hide",
      ...
      if (e.inline && !a) return Yo(i, r.y, l, r.height);
      {
        const a = t.header.isPositionedAtTop(),
          { y: c, bottom: d } = ((e, t, o, n, r, s) => {
            ...
            return d ? { y: Math.max(l.bottom + s, o.y), bottom: Math.min(u.bottom - s, o.bottom) } : { y: Math.max(u.y + s, o.y), bottom: Math.min(l.y - s, o.bottom) };
          })(e, s, r, a, o, n);
        return Yo(i, c, l, d - c);
      }
    },
    ...
    AD = { maxHeightFunction: cc(), maxWidthFunction: cA() },
    MD = (e) => "node" === e,
    DD = (e, t, o, n, r) => {
      const s = _D(e),
    ...
    BD = (e, t, o, n) => {
      const r = (t) => (n, r, s, a, i) => ({ ...DD(e, a, t, o, i)({ ...n, y: i.y, height: i.height }, r, s, a, i), alwaysFit: !0 }),
        s = (e) => (MD(n) ? [r(e)] : []);
      return t
      ...
      const r = n.backstage,
                ...
                Kp("context-toolbar-events", [
                  ...
                  Us(RD, (e, o) => {
                    Hh.getContent(e).each((o) => {
                      ...
                      Is(e, VD, { contents: o.event.forwardContents, focus: A.none() });
                  }),
                  Us(ND, (e, o) => {
                    ne(t.get()).each((o) => {
                      t.set(t.get().slice(0, t.get().length - 1)), Is(e, VD, { contents: ai(o.bar), focus: o.focus });
                    });
                  }),
                ]),
                Hp.config({
            ...
            i = q(
              H(t, (t) =>
                "contexttoolbar" === t.type
                  ? ((t, o) => lD(e, { buttons: t, toolbar: o.items, allowToolbarGroups: !1 }, n.backstage, A.some(["form:"])))(r, t)
                  : ((e, t) => CD(e, t))(t, s.providers)
              )
            );
        ...
        x = (t, n) => {
          ...
          const r = y(t),
            ...
            h = ((t, n) => {
              const r = "node" === t ? s.anchors.node(n) : s.anchors.cursor(),
                c = ((e, t, o, n) =>
                  "line" === t
                    ? { bubble: gc(12, 0, ED), layouts: { onLtr: () => [dl], onRtl: () => [ul] }, overrides: AD }
                    : { bubble: gc(0, 12, ED, 1 / 12), layouts: BD(e, o, n, t), overrides: AD })(e, t, a(), {
                  lastElement: i.get,
          ...
          Ht(b, "display"),
            ...
            Hh.showWithinBounds(d, f(r), { anchor: h, transition: { classes: [HD], mode: "placement" } }, () => A.some(u())),
                      ...
                      ((e, t, o) =>
                        e(t)
                          ...
                          : Fr(
                              ...
                              (e) => {
                                if (Ge(e)) {
                                  const { contextToolbars: t, contextForms: n } = FD(e, o.inNodeScope),
                                    r =
                                      n.length > 0
                                        ? n
                                        : ((e) => {
    ...
    UD = {
      ...
      icon: "line-height",
      getOptions: Kf,
      hash: (e) => ((e, t) => NM(e, ["fixed", "relative", "empty"]).map(({ value: e, unit: t }) => e + t))(e).getOr(e),
      display: w,
      ...
      ((e) => {
        ((e) => {
          MC.each(
            ...
            (t, o) => {
              e.ui.registry.addToggleButton(t.name, { tooltip: t.text, icon: t.icon, onSetup: bM(e, t.name), onAction: GD(e, t.name) });
            }
          );
          for (let t = 1; t <= 6; t++) {
            const o = "h" + t;
            e.ui.registry.addToggleButton(o, { text: o.toUpperCase(), tooltip: "Heading " + t, onSetup: bM(e, o), onAction: GD(e, o) });
          }
        })(e),
          ((e) => {
            MC.each(
          ...
          ((e) => {
            MC.each([{ name: "blockquote", text: "Blockquote", action: "mceBlockQuote", icon: "quote" }], (t) => {
        ...
        ((e) => {
          MC.each(
            ...
            e.ui.registry.addMenuItem("codeformat", { text: "Code", icon: "sourcecode", onAction: GD(e, "code") });
        })(e);
    },
    qD = (e, t) =>
    ...
    KD = (e, t) => {
      ((e) => {
        ...
        ((e, t) => {
          ((e, t) => {
            const o = SM(0, t, TM(e));
            e.ui.registry.addNestedMenuItem("align", { text: t.shared.providers.translate("Align"), getSubmenuItems: () => o.items.validateItems(o.getStyleItems()) });
          })(e, t),
            ((e, t) => {
              const o = SM(0, t, BM(e));
              e.ui.registry.addNestedMenuItem("fontfamily", { text: t.shared.providers.translate("Fonts"), getSubmenuItems: () => o.items.validateItems(o.getStyleItems()) });
            })(e, t),
            ((e, t) => {
              const o = { type: "advanced", ...t.styles },
                n = SM(0, t, WM(e, o));
              e.ui.registry.addNestedMenuItem("styles", { text: "Formats", getSubmenuItems: () => n.items.validateItems(n.getStyleItems()) });
            })(e, t),
            ((e, t) => {
              const o = SM(0, t, AM(e));
              e.ui.registry.addNestedMenuItem("blocks", { text: "Blocks", getSubmenuItems: () => o.items.validateItems(o.getStyleItems()) });
            })(e, t),
            ((e, t) => {
              const o = SM(0, t, PM(e));
              e.ui.registry.addNestedMenuItem("fontsize", { text: "Font sizes", getSubmenuItems: () => o.items.validateItems(o.getStyleItems()) });
            })(e, t);
        })(e, t),
        ((e) => {
          ((e) => {
            e.ui.registry.addMenuItem("undo", { text: "Undo", icon: "undo", shortcut: "Meta+Z", onSetup: qD(e, "hasUndo"), onAction: xM(e, "undo") }),
              e.ui.registry.addMenuItem("redo", { text: "Redo", icon: "redo", shortcut: "Meta+Y", onSetup: qD(e, "hasRedo"), onAction: xM(e, "redo") });
          })(e),
            ((e) => {
              e.ui.registry.addButton("undo", { tooltip: "Undo", icon: "undo", enabled: !1, onSetup: qD(e, "hasUndo"), onAction: xM(e, "undo") }),
                e.ui.registry.addButton("redo", { tooltip: "Redo", icon: "redo", enabled: !1, onSetup: qD(e, "hasRedo"), onAction: xM(e, "redo") });
            })(e);
        })(e),
        ((e) => {
          ((e) => {
        ...
        ((e) => {
          ((e) => {
            ...
            ((e) => {
              e.ui.registry.addToggleMenuItem("visualaid", { text: "Visual aids", onSetup: XD(e), onAction: xM(e, "mceToggleVisualAid") });
            })(e);
        })(e),
        ((e) => {
          ((e) => {
            e.ui.registry.addButton("outdent", { tooltip: "Decrease indent", icon: "outdent", onSetup: WD(e), onAction: xM(e, "outdent") }),
        ...
        ((e) => {
          ...
          e.ui.registry.addToggleButton("pastetext", { active: !1, icon: "paste-text", tooltip: "Paste as text", onAction: o, onSetup: jD(e, t) }),
            e.ui.registry.addToggleMenuItem("pastetext", { text: "Paste as text", icon: "paste-text", onAction: o, onSetup: jD(e, t) });
        })(e);
    },
    YD = (e) => (s(e) ? e.split(/[ ,]/) : e),
    ...
    nB = (e, t) =>
      "contextmenu" === t.type || "longpress" === t.type
        ...
        : rB(e),
    rB = (e) => ({ type: "selection", root: Ve(e.selection.getNode()) }),
    sB = (e, t, o) => {
      switch (o) {
        case "node":
    ...
    aB = (e, t, o, n, r, s) => {
      const a = o(),
        i = sB(e, t, s);
      ZC(a, ub.CLOSE_ON_EXECUTE, n, { isHorizontalMenu: !1, search: A.none() }).map((e) => {
        t.preventDefault(), Hh.showMenuAt(r, { anchor: i }, { menu: { markers: Ob("normal") }, data: e });
      });
    },
    iB = { onLtr: () => [cl, rl, sl, al, il, ll, R_, N_, I_, B_, F_, D_], onRtl: () => [cl, sl, rl, il, al, ll, R_, N_, F_, D_, I_, B_] },
    lB = {
      valignCentre: [],
      alignCentre: [],
      alignLeft: ["tox-pop--align-left"],
      ...
      const a = Do(),
        ...
        u = () => {
          ...
          ((e, t, o, n, r, s, a) => {
            const i = ((e, t, o) => {
              const n = sB(e, t, o);
              return { bubble: gc(0, "point" === o ? 12 : 0, lB), layouts: iB, overrides: { maxWidthFunction: cA(), maxHeightFunction: cc() }, ...n };
            })(e, t, s);
            ZC(o, ub.CLOSE_ON_EXECUTE, n, { isHorizontalMenu: !0, search: A.none() }).map((o) => {
              t.preventDefault();
              const l = a ? Nh.HighlightMenuAndItem : Nh.HighlightNone;
              Hh.showMenuWithinBounds(r, { anchor: i }, { menu: { markers: Ob("normal"), highlightOnOpen: l }, data: o, type: "horizontal" }, () =>
                A.some(TD(e, n.shared, "node" === s ? "node" : "selection"))
              ),
                e.dispatch(SD);
            });
          })(e, t, a, n, r, s, !(c || i || (l && d)));
    ...
    bB = Ar([{ offset: ["x", "y"] }, { absolute: ["x", "y"] }, { fixed: ["x", "y"] }]),
    ...
    MB = (e, t, o, n, r, s) => {
      const a = ((e, t, o, n) =>
          ((e, t) => {
            ...
            () => o,
            (e) => EB(e.left + n.left, e.top + n.top)
          ))(e, t, o, n),
      ...
      return (
        ...
        i.fold(
          () => ({ coord: EB(l.left, l.top), extra: A.none() }),
  ...
  const RB = "data-initial-z-index",
    ...
    zB = (e, t, o) =>
      e
        .getSystem()
        .build(
          jw.sketch({ dom: { styles: { left: "0px", top: "0px", width: "100%", height: "100%", position: "fixed", "z-index": "1000000000000000" }, classes: [t] }, events: o })
        );
  ...
  const LB = [yr("useFixed", T), or("blockerClass"), yr("getTarget", w), yr("onDrag", b), yr("repositionTarget", !0), yr("onDrop", b), Or("getBounds", en), HB],
    PB = (e) => {
      ...
      t.isSome() && o.isSome() && n.isSome()
        ? A.some(((e, t, o) => ("fixed" === o ? EB : _B)(parseInt(e, 10), parseInt(t, 10)))(t.getOrDie(), o.getOrDie(), n.getOrDie()))
        : A.none()).getOrThunk(() => {
        const t = Xt(e);
    ...
    UB = (e, t) => ({ bounds: e.getBounds(), height: jt(t.element), width: Zt(t.element) }),
    WB = (e, t, o, n, r) => {
  ...
  var $B = Object.freeze({ __proto__: null, getData: (e) => A.from($t(e.x, e.y)), getDelta: (e, t) => $t(t.left - e.left, t.top - e.top) });
  const qB = (e, t, o) => [
      Us(Wr(), (n, r) => {
    ...
    XB = [...LB, Ri("dragger", { handlers: GB(qB) })];
  ...
  const YB = (e, t, o) => {
    ...
    JB = XB,
    ZB = [...LB, Ri("dragger", { handlers: GB(YB) })],
    QB = [...LB, Ri("dragger", { handlers: GB((e, t, o) => [...qB(e, t, o), ...YB(e, t, o)]) })];
  var eF = Object.freeze({ __proto__: null, mouse: JB, touch: ZB, mouseOrTouch: QB }),
    tF = Object.freeze({
      __proto__: null,
      init: () => {
        let e = A.none(),
  ...
  const oF = Tl({
    ...
    nF = (e, t, o, n, r, s) =>
      e.fold(
        () => oF.snap({ sensor: TB(o - 20, n - 20), range: $t(r, s), output: TB(A.some(o), A.some(n)), extra: { td: t } }),
        (e) => {
          const r = o - 20,
            s = n - 20,
            a = e.element.dom.getBoundingClientRect();
          return oF.snap({ sensor: TB(r, s), range: $t(40, 40), output: TB(A.some(o - a.width / 2), A.some(n - a.height / 2)), extra: { td: t } });
        }
      ),
    rF = (e, t, o) => ({
      getSnapPoints: e,
    ...
    sF = (e) =>
      Uh(
        Ph.sketch({
          ...
          buttonBehaviours: kl([oF.config({ mode: "mouseOrTouch", blockerClass: "blocker", snaps: e }), SS.config({})]),
                      ...
                      s.length > 0
                        ? j(
                            ...
                            (t, n, s) => {
                              const a = ((t, n, r) =>
                                Ph.sketch({
                                  dom: { tag: "div", classes: ["tox-statusbar__path-item"], attributes: { "data-index": r, "aria-level": r + 1 } },
                                  components: [ti(t)],
                                  action: (t) => {
                              ...
                              return 0 === s
                                ? t.concat([a])
                                : t.concat([{ dom: { tag: "div", classes: ["tox-statusbar__path-divider"], attributes: { "aria-hidden": !0 } }, components: [ti(` ${r} `)] }, a]);
                            },
                            []
                          )
                        : [];
  ...
  const cF = (e, t, o) => {
      const n = Ve(e.getContainer()),
        r = ((e, t, o, n, r) => {
          const s = { height: hD(n + t.top, pf(e), ff(e)) };
              ...
              : A.some(
                  Zh(
                    "resize-handle",
                    {
                      ...
                      behaviours: [
                        oF.config({ mode: "mouse", repositionTarget: !1, onDrag: (t, n, r) => cF(e, r, o), blockerClass: "tox-blocker" }),
                        Hp.config({ mode: "special", onLeft: () => dF(e, o, -1, 0), onRight: () => dF(e, o, 1, 0), onUp: () => dF(e, o, 0, -1), onDown: () => dF(e, o, 0, 1) }),
                        Jw.config({}),
                        eh.config({}),
                      ],
                    },
    ...
    gF = (e, t) => {
        ...
        v = () => {
          const t = (() => {
            ...
            n = {
              ...
              components: [aM.parts.socket({ dom: { tag: "div", classes: ["tox-edit-area"] } }), aM.parts.sidebar({ dom: { tag: "div", classes: ["tox-sidebar"] } })],
            },
      ...
      return {
        popups: { backstage: b.popup, getMothership: () => mF("popups", l) },
        dialogs: { backstage: b.dialog, getMothership: () => mF("dialogs", i) },
        renderUI: () => {
          const o = v(),
            a = (() => {
              const t = ob(e),
                ...
                n = {
                  dom: { tag: "div", classes: ["tox", "tox-silver-sink", "tox-tinymce-aux"].concat(c), attributes: { ...(Wh.isRtl() ? { dir: "rtl" } : {}) } },
          ...
          return ((t) => {
            ...
            const { buttons: i, menuItems: l, contextToolbars: c, sidebars: d, views: m } = e.ui.registry.getAll(),
              p = Jf(e),
              h = { menuItems: l, menus: ab(e), menubar: Af(e), toolbar: p.getOrThunk(() => Mf(e)), allowToolbarGroups: u === tf.floating, buttons: i, sidebar: d, views: m };
            var v;
            (v = o.outerContainer),
              ...
              KD(e, b.popup),
              fB(e, b.popup.shared.getSink, b.popup),
              ((e) => {
              ...
              LD(e, c, s.sink, { backstage: b.popup }),
              aF(e, s.sink);
    ...
    fF = x([
      ...
      Lu({ factory: hF, schema: [or("dom")], name: "close" }),
      Lu({ factory: hF, schema: [or("dom")], name: "body" }),
      Uu({ factory: hF, schema: [or("dom")], name: "footer" }),
      Pu({
        factory: { sketch: (e, t) => ({ ...e, dom: t.dom, components: t.components }) },
        schema: [yr("dom", { tag: "div", styles: { position: "fixed", left: "0px", top: "0px", right: "0px", bottom: "0px" } }), yr("components", [])],
        name: "blocker",
      }),
    ]),
    bF = hm({
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          behaviours: hu(e.modalBehaviours, [
            Xp.config({}),
            Hp.config({ mode: "cyclic", onEnter: e.onExecute, onEscape: e.onEscape, useTabstopAt: e.useTabstopAt, firstTabstop: e.firstTabstop }),
    ...
    OF = Jn("type", { submit: SF, cancel: SF, custom: SF, menu: kF, togglebutton: CF }),
    ...
    AI = TI.concat([
      dr(
        "children",
        Zn(0, () => jn("type", { directory: MI, leaf: EI }))
      ),
    ]),
    MI = Dn(AI),
    DI = jn("type", { directory: MI, leaf: EI }),
    ...
    VI = (e) =>
      Qn(
        ...
        Bn(
          Gn((t) =>
            qn(`Checking item of ${e}`, zI, t).fold(
              (e) => rn.error(Yn(e)),
              (e) => rn.value(e)
            )
          )
    ...
    $I = Dn([
      sr("title"),
      nr("body", jn("type", { panel: LI, tabpanel: WI })),
      Sr("size", "normal"),
      dr("buttons", GI),
      yr("initialData", {}),
      Or("onAction", b),
    ...
    QI = (e) => {
      var t;
      return { internalDialog: Xn(qn("dialog", $I, e)), dataValidator: ZI(e), initialData: null !== (t = e.initialData) && void 0 !== t ? t : {} };
    },
    eR = {
      open: (e, t) => {
        const o = QI(t);
  ...
  const rR = Ol({
    ...
    aR = (e, t, o) => {
      const n = Uh(mC.sketch((n) => ({ dom: { tag: "div", classes: ["tox-form"].concat(e.classes) }, components: H(e.items, (e) => w_(n, e, t, o)) })));
      return {
        dom: { tag: "div", classes: ["tox-dialog__body"] },
        components: [{ dom: { tag: "div", classes: ["tox-dialog__body-content"] }, components: [n.asSpec()] }],
        behaviours: kl([
          Hp.config({ mode: "acyclic", useTabstopAt: C(VC) }),
          ((r = n), ym.config({ find: r.getOpt })),
          CC(n, { postprocess: (e) => sR(e).fold((e) => (console.error(e), {}), w) }),
        ]),
      };
      var r;
    },
    ...
    uR = hm({
      ...
      factory: (e, t, o, n) => ({
        ...
        behaviours: hu(e.tabbarBehaviours, [
          ...
          Hp.config({ mode: "flow", getInitial: (e) => Wm.getHighlighted(e).map((e) => e.element), selector: "." + e.markers.tabClass, executeOnMove: !0 }),
        ]),
      }),
    }),
    mR = pm({
      ...
      factory: (e, t) => ({ uid: e.uid, dom: e.dom, behaviours: hu(e.tabviewBehaviours, [Xp.config({})]), domModification: { attributes: { role: "tabpanel" } } }),
    }),
    gR = x([yr("selectFirst", !0), Di("onChangeTab"), Di("onDismissTab"), yr("tabs", []), gu("tabSectionBehaviours", [])]),
    pR = Lu({ factory: uR, schema: [or("dom"), lr("markers", [or("tabClass"), or("selectedClass")])], name: "tabbar", defaults: (e) => ({ tabs: e.tabs }) }),
    hR = Lu({ factory: mR, name: "tabview" }),
    fR = x([pR, hR]),
    bR = hm({
      name: "TabSection",
      configFields: gR(),
    ...
    kR = (e, t, o) => {
      ...
      return bR.sketch({
        ...
        components: [
          ...
          bR.parts.tabview({ dom: { tag: "div", classes: ["tox-dialog__body-content"] } }),
        ],
        selectFirst: l.selectFirst,
        tabSectionBehaviours: kl([
          Kp("tabpanel", l.extraEvents),
          Hp.config({ mode: "acyclic" }),
          ym.config({ find: (e) => oe(bR.getViewItems(e)) }),
          _C(
            A.none(),
            (e) => (e.getSystem().broadcastOn([wR], {}), n.get()),
            (e, t) => {
    ...
    AR = (e, t, o, n, r) => ({
      dom: { tag: "div", classes: ["tox-dialog__content-js"], attributes: { ...o.map((e) => ({ id: e })).getOr({}), ...(r ? { "aria-live": "polite" } : {}) } },
      components: [],
      behaviours: kl([
        xC(0),
        rR.config({
      ...
      (function (e, t) {
        if (e) {
          ...
          return (
            ...
            "Map" === o || "Set" === o ? Array.from(e) : "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? RR(e, t) : void 0
          );
        }
      })(e) ||
      (function () {
  ...
  var lN = PR([
    ...
    AN = (function e() {
      ...
      var D,
        ...
        ke = function (e) {
          (xe && xe === e) ||
            ...
            (ue = "ADD_URI_SAFE_ATTR" in e ? sN(aN(me), e.ADD_URI_SAFE_ATTR) : me),
            (ce = "ADD_DATA_URI_TAGS" in e ? sN(aN(de), e.ADD_DATA_URI_TAGS) : de),
            ...
            (fe = e.NAMESPACE || he),
            e.CUSTOM_ELEMENT_HANDLING && Se(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (j.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
            e.CUSTOM_ELEMENT_HANDLING && Se(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (j.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
            ...
            ae &&
              ((L = sN({}, IR(pN))),
              (U = []),
              !0 === ae.html && (sN(L, lN), sN(U, hN)),
              !0 === ae.svg && (sN(L, cN), sN(U, fN), sN(U, vN)),
              !0 === ae.svgFilters && (sN(L, dN), sN(U, fN), sN(U, vN)),
              !0 === ae.mathMl && (sN(L, mN), sN(U, bN), sN(U, vN))),
            e.ADD_TAGS && (L === P && (L = aN(L)), sN(L, e.ADD_TAGS)),
            e.ADD_ATTR && (U === W && (U = aN(U)), sN(U, e.ADD_ATTR)),
            e.ADD_URI_SAFE_ATTR && sN(ue, e.ADD_URI_SAFE_ATTR),
            e.FORBID_CONTENTS && (ie === le && (ie = aN(ie)), sN(ie, e.FORBID_CONTENTS)),
            re && (L["#text"] = !0),
      ...
      var Ae = function (e) {
            ...
            : e.namespaceURI === ge
              ? t.namespaceURI === he
                ...
                : t.namespaceURI === pe
                  ? "math" === o && Oe[n]
                  : Boolean(Ee[o])
              : e.namespaceURI === he && !(t.namespaceURI === pe && !Oe[n]) && !(t.namespaceURI === ge && !Ce[n]) && !Ee[o] && (_e[o] || !Te[o]);
        },
        Me = function (e) {
          YR(o.removed, { element: e });
          try {
        ...
        De = function (e, t) {
          try {
            YR(o.removed, { attribute: t.getAttributeNode(e), from: t });
          } catch (e) {
            YR(o.removed, { attribute: null, from: t });
          }
        ...
        Ve = function (e) {
          ...
          if (
            ...
            e.hasChildNodes() && !Re(e.firstElementChild) && (!Re(e.content) || !Re(e.content.firstElementChild)) && oN(/<[/\w]/g, e.innerHTML) && oN(/<[/\w]/g, e.textContent))
          )
            return Me(e), !0;
          ...
          return e instanceof l && !Ae(e)
            ? (Me(e), !0)
            : ("noscript" !== n && "noembed" !== n) || !oN(/<\/no(script|embed)/i, e.innerHTML)
              ? (Y &&
                  3 === e.nodeType &&
                  ((t = e.textContent), (t = QR(t, F, " ")), (t = QR(t, I, " ")), e.textContent !== t && (YR(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
        ...
        ze = function (e, t, o) {
          ...
          if (X && !$[t] && oN(R, t));
            ...
            if (
              !(
                (He(e) &&
                  ((j.tagNameCheck instanceof RegExp && oN(j.tagNameCheck, e)) || (j.tagNameCheck instanceof Function && j.tagNameCheck(e))) &&
                  ((j.attributeNameCheck instanceof RegExp && oN(j.attributeNameCheck, t)) || (j.attributeNameCheck instanceof Function && j.attributeNameCheck(t)))) ||
                ("is" === t &&
                  j.allowCustomizedBuiltInElements &&
                  ((j.tagNameCheck instanceof RegExp && oN(j.tagNameCheck, o)) || (j.tagNameCheck instanceof Function && j.tagNameCheck(o))))
              )
            )
              return !1;
          } else if (ue[t]);
        ...
        (o.sanitize = function (e, r) {
          ...
          return (
            J &&
              ...
              oN(_N, a.ownerDocument.doctype.name) &&
  ...
  const MN = (e) => AN().sanitize(e),
    ...
    BN = (e, t) => ({ dom: { tag: "div", styles: { display: "none" }, classes: ["tox-dialog__header"] }, components: [e, t] }),
    FN = (e, t) =>
      bF.parts.close(
        Ph.sketch({
    ...
    IN = () => bF.parts.title({ dom: { tag: "div", classes: ["tox-dialog__title"], innerHtml: "", styles: { display: "none" } } }),
    RN = (e, t) =>
      bF.parts.body({
        dom: { tag: "div", classes: ["tox-dialog__body"] },
        components: [{ dom: { tag: "div", classes: ["tox-dialog__body-content"] }, components: [{ dom: ZE(`<p>${MN(t.translate(e))}</p>`) }] }],
      }),
    NN = (e) => bF.parts.footer({ dom: { tag: "div", classes: ["tox-dialog__footer"] }, components: e }),
    VN = (e, t) => [
    ...
    zN = (e) => {
      ...
      return bF.sketch({
        ...
        parts: { blocker: { dom: ZE(`<div class="${o}"></div>`), components: [{ dom: { tag: "div", classes: DN ? [n, n + "--opaque"] : [n] } }] } },
        dragBlockClass: o,
        modalBehaviours: kl([
          eh.config({}),
          Kp(
    ...
    LN = (e, t, o, n) => ({
      ...
      components: [],
      behaviours: kl([rR.config({ channel: `${OR}-${t}`, initialData: e, renderComponents: (e) => [ti(n.translate(e.title))] })]),
    }),
    PN = () => ({ dom: ZE('<div class="tox-dialog__draghandle"></div>') }),
    UN = (e, t, o) =>
      ((e, t, o) => {
    ...
    GN = (e, t, o, n) =>
      si(
        zN({
          ...
          extraBehaviours: [rR.config({ channel: `${CR}-${e.id}`, updateState: (e, t) => A.some(t), initialData: t }), TC({}), ...e.extraBehaviours],
          onEscape: (e) => {
            Fs(e, sS);
          },
          dialogEvents: o,
        ...
        r = {
          ...
          redial: (s) => {
            n((n) => {
              ...
              n.getSystem().broadcastOn([`${CR}-${a}`], i),
                n.getSystem().broadcastOn([`${OR}-${a}`], i.internalDialog),
                n.getSystem().broadcastOn([`${_R}-${a}`], i.internalDialog),
                n.getSystem().broadcastOn([`${TR}-${a}`], { ...i.internalDialog, buttons: l }),
  ...
  const oV = ["insertContent", "setContent", "execCommand", "close", "block", "unblock"],
    ...
    rV = (e, t, o, n) => {
      const r = la("dialog"),
            ...
            components: [
              {
                ...
                components: [IC({ dom: { tag: "iframe", attributes: { src: e.url } }, behaviours: kl([Jw.config({}), eh.config({})]) })],
              },
            ],
            behaviours: kl([Hp.config({ mode: "acyclic", useTabstopAt: C(VC) })]),
          };
          return bF.parts.body(t);
        })(e),
        c = e.buttons.bind((e) => (0 === e.length ? A.none() : A.some(ZN({ buttons: e }, r, n)))),
        u = ((e, t) => {
          const o = (t, o) =>
              Us(t, (t, r) => {
                n(t, (n, s) => {
        ...
        h = new tV(e.url, { base_uri: new tV(window.location.href) }),
              ...
              const t = tc(Ve(window), "message", (t) => {
                if (h.isSameOrigin(new tV(t.raw.origin))) {
                  ...
                  nV(n)
                    ...
                    : ((e) => !nV(e) && a(e) && ve(e, "mceAction"))(n) && e.onMessage(x, n);
                }
              });
              b.set(t);
            }),
        ...
        y = GN({ id: r, header: i, body: l, footer: c, extraClasses: p, extraBehaviours: v, extraStyles: m }, e, u, n),
        x = ((e) => {
          const t = (t) => {
      ...
      t && o
        ...
        : [
            vE.config({
              ...
              lazyViewport: (t) =>
                Bw(e, t.element)
                  .map((e) => ({ bounds: Fw(e), optScrollEnv: A.some({ currentScrollTop: e.element.dom.scrollTop, scrollElmTop: Xt(e.element).top }) }))
          ...
          return {
            open: (o, n) => {
              const r = () => {
                ...
                s = Uh(s_({ name: "close-alert", text: "OK", primary: !0, buttonType: A.some("primary"), align: "end", enabled: !0, icon: A.none() }, "cancel", e)),
                a = IN(),
                i = FN(r, t.providers),
                l = si(
                  zN({
          ...
          return {
            open: (o, n) => {
              const r = (e) => {
                ...
                s = Uh(s_({ name: "yes", text: "Yes", primary: !0, buttonType: A.some("primary"), align: "end", enabled: !0, icon: A.none() }, "submit", e)),
                a = s_({ name: "no", text: "No", primary: !1, buttonType: A.some("secondary"), align: "end", enabled: !0, icon: A.none() }, "cancel", e),
                i = IN(),
            ...
            const c = Xn(qn("data", l, i)),
              ...
              g = ((e, t, o, n) => {
                const r = la("dialog"),
                  ...
                  c = Uh(((e, t, o, n, r) => AR(e, t, A.some(o), n, r))({ body: i.body, initialData: i.initialData }, r, a, o, n)),
                  d = $N(i.buttons),
                  u = qN(d),
                  m = Uh(((e, t, o) => JN(e, t, o))({ buttons: d }, r, o)),
                  g = KN(
                    () => f,
                    {
                      onBlock: (e) => {
                  ...
                  p = "tox-dialog-inline",
                  h = si({
                    dom: { tag: "div", classes: ["tox-dialog", p], attributes: { role: "dialog", "aria-labelledby": s, "aria-describedby": a } },
                    eventOrder: { [ds()]: [rR.name(), Al.name()], [us()]: ["execute-on-form"], [Ss()]: ["reflecting", "execute-on-form"] },
                    behaviours: kl([
                      Hp.config({
                        mode: "cyclic",
                      ...
                      rR.config({ channel: `${CR}-${r}`, updateState: (e, t) => A.some(t), initialData: e }),
                      eh.config({}),
                      Kp(
                        "execute-on-form",
                        g.concat([
      ...
      cf(e),
        ((e) => {
          ...
          t("color_map", {
            ...
            t("color_default_foreground", { processor: "string", default: Ox }),
            t("color_default_background", { processor: "string", default: Ox });
        })(e),
        ((e) => {
          const t = e.options.register;
          t("contextmenu_avoid_overlap", { processor: "string", default: "" }),
            ...
            t("contextmenu", {
              processor: (e) => (!1 === e ? { value: [], valid: !0 } : s(e) || f(e, s) ? { value: YD(e), valid: !0 } : { valid: !1, message: "Must be false or a string." }),
              default: "link linkchecker image editimage table spellchecker configurepermanentpen",
            });
        })(e);
    })(e);
    let t = () => en();
    const { dialogs: o, popups: n, renderUI: r } = gF(e, { getPopupSinkBounds: () => t() });
    Aw(e, n.backstage.shared);
    const a = aV({ editor: e, backstages: { popup: n.backstage, dialog: o.backstage } });
    return {
      renderUI: async () => {
        const o = await r();
        return (
              ...
              const c = {
                ...
                reposition: () => {
                  ...
                  if (s[0] === c) {
                    ...
                    I(s, c).each((e) => {
                      const n = s[e - 1].getEl(),
                        a = { type: "node", root: xt(), node: A.some(Ve(n)), overrides: o, layouts: { onRtl: () => [cl], onLtr: () => [cl] } };
