...
!(function () {
      ...
      ((e) => {
        ...
        return null === e
          ...
          : "object" === t && Array.isArray(e)
            ? "array"
            : "object" === t && ((a = n = e), (r = String).prototype.isPrototypeOf(a) || (null === (s = n.constructor) || void 0 === s ? void 0 : s.name) === r.name)
              ? "string"
              : t;
        var a, n, r, s;
      })(t) === e,
  ...
  const c = (e) => (t) => t.options.get(e),
    ...
    M = (e, t, a = new Date()) => {
      ...
      return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace("%D", "%m/%d/%Y")).replace("%r", "%I:%M:%S %p")).replace(
        "%Y",
        "" + a.getFullYear()
      )).replace("%y", "" + a.getYear())).replace("%m", b(a.getMonth() + 1, 2))).replace("%d", b(a.getDate(), 2))).replace("%H", "" + b(a.getHours(), 2))).replace(
        "%M",
        "" + b(a.getMinutes(), 2)
      )).replace("%S", "" + b(a.getSeconds(), 2))).replace("%I", "" + (((a.getHours() + 11) % 12) + 1))).replace("%p", a.getHours() < 12 ? "AM" : "PM")).replace(
        "%B",
        "" + e.translate(l[a.getMonth()])
      )).replace("%b", "" + e.translate(s[a.getMonth()]))).replace("%A", "" + e.translate(r[a.getDay()]))).replace("%a", "" + e.translate(n[a.getDay()]))).replace("%%", "%");
    };
  class T {
    constructor(e, t) {
    ...
    (() => {
      ...
      return T.from(
        o.map(t, (e, t) => {
          ...
          return { selected: 0 === t, text: e.title, value: { url: a(e) ? T.from(e.url) : T.none(), content: a(e) ? T.none() : T.from(e.content), description: e.description } };
        })
      );
    })().each((t) => {
      const a = ((e) =>
