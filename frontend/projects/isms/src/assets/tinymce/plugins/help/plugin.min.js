...
!(function () {
        ...
        ((e) => {
          ...
          return null === e
            ...
            : "object" === t && Array.isArray(e)
              ? "array"
              : "object" === t && ((n = a = e), (o = String).prototype.isPrototypeOf(n) || (null === (i = a.constructor) || void 0 === i ? void 0 : i.name) === o.name)
                ? "string"
                : t;
          var n, a, o, i;
        })(e));
  ...
  const S = (e, t) => () => {
    const { tabs: a, names: i } = ((e, t) => {
        const a = A(),
          ...
          l = (() => {
            ...
            return { name: "versions", title: "Version", items: [{ type: "htmlpanel", html: "<p>" + T.translate(["You are using {0}", n]) + "</p>", presets: "document" }] };
          })(),
    ...
    e.windowManager.open({ title: "Help", size: "normal", body: s, buttons: [{ type: "cancel", name: "close", text: "Close", primary: !0 }], initialData: {} });
  };
  e.add("help", (e) => {
    const t = ((e) => {
        let t = {};
