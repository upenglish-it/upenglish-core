        ...
        .fold(
          () => {
            ...
            const o = ((e, t, n) =>
              H(e)
                .filter(_)
                .map((r) => ({ depth: t, dirty: !1, isSelected: n, content: at(e), itemAttributes: ie(e), listAttributes: ie(r), listType: $(r) })))(r, e, n.get());
            t.each((e) => {
              U(e.end, r) && n.set(!1);
            });
            const s = z(r)
      ...
      const t = {},
        n = (n) => {
          ...
          if (ge(r)) {
            ...
            r.hasChildNodes() ? ((o = Math.min(o, r.childNodes.length - 1)), n ? r.insertBefore(e, r.childNodes[o]) : St.insertAfter(e, r.childNodes[o])) : r.appendChild(e),
              (r = e),
              (o = 0);
          }
    ...
    xt = (e, t, n, r) => {
      ...
      const i = (t, n) => {
        ...
        const s = new ee(t, r),
          i = n ? "next" : "prev";
        let l;
        for (; (l = s[i]()); ) if (!Oe(e, l) && !Ct(l.textContent) && 0 !== (null === (o = l.textContent) || void 0 === o ? void 0 : o.length)) return g.some(l);
        return g.none();
      };
      if (n && pe(o))
      ...
      if (!n && pe(o))
        ...
        else for (null !== o.parentNode && At(e, o.parentNode) && (o = o.parentNode); null !== o.nextSibling && (At(e, o.nextSibling) || pe(o.nextSibling)); ) o = o.nextSibling;
      for (; o.parentNode !== r; ) {
    ...
    wt = (e, t, n) => {
          ...
          return (
            ce.each(a, (t) => {
              ...
              bt.isBookmarkNode(t) && (he(i) || Ne(e, i) || (!i && t.parentNode === n))
                ? (l = null)
                : (l || ((l = o.create("p")), null === (s = t.parentNode) || void 0 === s || s.insertBefore(l, t), r.push(l)), l.appendChild(t));
            }),
            r
          );
        })(e, r, s);
      ce.each(a, (r) => {
        ...
        ve(a) ||
          ...
          ((e, t, n) => {
            ce.each(["margin", "margin-right", "margin-bottom", "margin-left", "margin-top", "padding", "padding-right", "padding-bottom", "padding-left", "padding-top"], (n) =>
              e.setStyle(t, n, "")
            );
          })(i, r),
          Tt(i, s, n),
        ...
        ((e) => {
          ...
          ye(t) &&
            ...
            e.windowManager.open({
              ...
              initialData: { start: Kt({ start: e.dom.getAttrib(t, "start", "1"), listStyleType: g.from(e.dom.getStyle(t, "list-style-type")) }) },
              buttons: [
  ...
  e.add(
    ...
    (e) => (
      ...
      ((e) => {
        ...
        e.hasPlugin("advlist") ||
          (e.ui.registry.addToggleButton("numlist", { icon: "ordered-list", active: !1, tooltip: "Numbered list", onAction: t("InsertOrderedList"), onSetup: Jt(e, "OL") }),
          e.ui.registry.addToggleButton("bullist", { icon: "unordered-list", active: !1, tooltip: "Bullet list", onAction: t("InsertUnorderedList"), onSetup: Jt(e, "UL") }));
      })(e),
      ((e) => {
