...
!(function () {
      ...
      ((e) => {
        ...
        return null === e
          ...
          : "object" === t && Array.isArray(e)
            ? "array"
            : "object" === t && ((r = a = e), (o = String).prototype.isPrototypeOf(r) || (null === (s = a.constructor) || void 0 === s ? void 0 : s.name) === o.name)
              ? "string"
              : t;
        var r, a, o, s;
      })(t) === e,
      ...
      for (let a = A({ validate: !1, forced_root_block: !1 }, t).parse(e); a; a = a.walk())
        if (1 === a.type) {
          ...
          r.source || "param" !== e || (r.source = a.attr("movie")),
            ("iframe" !== e && "object" !== e && "embed" !== e && "video" !== e && "audio" !== e) || (r.type || (r.type = e), (r = k.extend(a.attributes.map, r))),
  ...
  const F = (e, t = {}) => A({ forced_root_block: !1, validate: !1, allow_conditional_comments: !0, ...t }, e),
    ...
    B = (e, t) => {
      ...
      if (
        (o && ((a.source = o.url), (a.type = o.type), (a.allowfullscreen = o.allowFullscreen), (a.width = a.width || String(o.w)), (a.height = a.height || String(o.h))), a.embed)
      )
    ...
    Z = (e) => {
      const t = ((e) => {
        ...
        s = { title: "General", name: "general", items: l([[{ name: "source", type: "urlinput", filetype: "media", label: "Source" }], o]) },
        i = [];
  ...
  const te = (e) => {
    ...
    oe = (e, t) => {
      const r = t.name,
        a = new $("img", 1);
      return ie(e, t, a), ae(t, a, {}), a.attr({ style: t.attr("style"), src: ee.transparentSrc, "data-mce-object": r, class: "mce-object mce-object-" + r }), a;
    },
    se = (e, t) => {
      var r;
      const a = t.name,
        o = new $("span", 1);
      o.attr({ contentEditable: "false", style: t.attr("style"), "data-mce-object": a, class: "mce-preview-object mce-object-" + a }), ie(e, t, o);
          ...
          c("webkitallowfullscreen mozallowfullscreen".split(" "), (e) => {
            ...
            a.addNodeFilter(
              ...
              ((e) => (t) => {
                let r,
                  a = t.length;
                for (; a--; ) (r = t[a]), r.parent && (r.parent.attr("data-mce-object") || (te(r) && v(e) ? ce(r) || r.replace(se(e, r)) : ce(r) || r.replace(oe(e, r))));
              })(e)
            ),
        ...
        e.on("click keyup touchend", () => {
          ...
          e.on("ObjectResized", (t) => {
            ...
            if (r.getAttribute("data-mce-object")) {
              ...
              a && ((a = unescape(a)), r.setAttribute("data-mce-html", escape(E(a, { width: String(t.width), height: String(t.height) }, !1, e.schema))));
            }
          });
      })(e),
      ((e) => ({
