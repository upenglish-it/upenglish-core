...
!(function () {
  ...
  const f = (t) => (e) => e.options.get(t),
    ...
    T = (t, e, o) => {
      ...
      for (let o = 0; o < t.length && ((0 !== e.length && !L(t[o], s)) || (n.push({ value: t[o].char, text: t[o].title, icon: t[o].char }), !a(n.length))); o++);
      return n;
    },
    D = "pattern",
    E = (t, e) => {
  ...
  t.add("emoticons", (t, e) => {
    ...
    const o = ((t, e, o) => {
      const n = p(),
        ...
        r = C(t),
        i = (t) => {
          return (o = "<img"), (e = t.char).length >= o.length && e.substr(0, 0 + o.length) === o ? t.char.replace(/src="([^"]+)"/, (t, e) => `src="${r}${e}"`) : t.char;
          var e, o;
        };
      t.on("init", () => {
        y.load(o, e).then(
