...
!(function () {
  ...
  const L = (e) => (t) => ((e) => e.dom.nodeType)(t) === e,
    ...
    re = (e) => (t) => k(t, e),
    oe = [
      { name: "Edge", versionRegexes: [/.*?edge\/ ?([0-9]+)\.([0-9]+)$/], search: (e) => k(e, "edge/") && k(e, "chrome") && k(e, "safari") && k(e, "applewebkit") },
      { name: "Chromium", brand: "Chromium", versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, ne], search: (e) => k(e, "chrome") && !k(e, "chromeframe") },
      { name: "IE", versionRegexes: [/.*?msie\ ?([0-9]+)\.([0-9]+).*/, /.*?rv:([0-9]+)\.([0-9]+).*/], search: (e) => k(e, "msie") || k(e, "trident") },
      { name: "Opera", versionRegexes: [ne, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: re("opera") },
      { name: "Firefox", versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: re("firefox") },
      { name: "Safari", versionRegexes: [ne, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: (e) => (k(e, "safari") || k(e, "mobile/")) && k(e, "applewebkit") },
    ],
    se = [
    ...
    xe = (e) => {
      const t = e.current,
        n = e.version,
        r = (e) => () => t === e;
      return { current: t, version: n, isWindows: r(pe), isiOS: r("iOS"), isAndroid: r(fe), isMacOS: r(we), isLinux: r(ve), isSolaris: r(ye), isFreeBSD: r(be), isChromeOS: r(Se) };
    },
        ...
        const r = ie.browsers(),
          ...
          l = ((e, t, n, r) => {
            const o = e.isiOS() && !0 === /ipad/i.test(n),
              ...
              d = !c && !a && !u;
            return { isiPad: g(o), isiPhone: g(s), isTablet: g(a), isPhone: g(c), isTouch: g(l), isAndroid: e.isAndroid, isiOS: e.isiOS, isWebView: g(u), isDesktop: g(d) };
          })(i, s, e, n);
    ...
    return (
      t.inline ||
        ...
        ((e, t) => {
          ...
          e.ui.registry.addToggleMenuItem("fullscreen", { text: "Fullscreen", icon: "fullscreen", shortcut: "Meta+Shift+F", onAction: n, onSetup: Ye(e, t) }),
