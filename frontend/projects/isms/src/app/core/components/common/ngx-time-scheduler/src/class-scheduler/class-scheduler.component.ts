...
@Component({
  selector: "isms-class-scheduler[items][periods][sections]",
...
export class ClassSchedulerComponent implements OnInit, OnDestroy, OnChanges {
  ...
  constructor(
    ...
    console.log("startOf>>>", moment().startOf("week"));
  }
  ...
  public ngOnChanges(changes: SimpleChanges) {
    if (this.currentPeriod?.timeFrameOverall) {
      this.refreshView();
    }
  }
