...
import { StaffListingComponent } from "@isms-core/components/staffs/staff-listing/staff-listing.component";
import { ManageSalaryListingComponent } from "@isms-core/components/staffs/manage-salary-listing/manage-salary-listing.component";
import { LeaveTrackerListingComponent } from "@isms-core/components/staffs/leave-tracker-listing/leave-tracker-listing.component";
...
@Component({
  ...
  imports: [
    ...
    ManageSalaryListingComponent,
    LeaveTrackerListingComponent,
  ],
})
export class StaffsPage {
  ...
  public segmentOptions: Array<ISegmentSelector> = [
    {
      label: "Staffs",
      description: "Your created staffs",
  ...
  constructor(private readonly activatedRoute: ActivatedRoute) {
    ...
    // console.log("this.activatedRoute.snapshot.queryParams;", this.activatedRoute.snapshot.queryParams?.tab);
  }
}
