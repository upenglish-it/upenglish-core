...
import { AnnouncementListingComponent } from "@isms-core/components/announcements/announcement-listing/announcement-listing.component";

@Component({
  templateUrl: "./announcements.page.html",
  animations: [Animations.down, Animations.default],
  imports: [NgIf, SegmentedSelectorComponent, AnnouncementListingComponent],
})
