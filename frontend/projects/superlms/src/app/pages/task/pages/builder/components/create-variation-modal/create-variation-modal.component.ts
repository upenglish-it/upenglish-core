...
export class ChooseTestModalComponent implements OnInit {
  ...
  public testFormGroup = new FormGroup({
    testsOfCourseId: new FormControl(),
  ...
  public onCreate(): void {
    this.apiService.endPointsC.testOfCourse.post
      .addTest(this.apiService, {
        testOfCourseId: this.testFormGroup.value.testsOfCourseId,
        courseId: this.testFormGroup.value.courseId,
