...
//--- Components
import { AnswerBoxConfigModalComponent } from "../table-box-config-modal/table-box-config-modal.component";
import { debounceTime, distinctUntilChanged } from "rxjs";
//--- Directives
import { TableBoxAnswerChoiceEditorDirectiveRenderer } from "../table-box-answer-choice-editor/directives/table-box-answer-choice-editor-renderer/table-box-answer-choice-editor-renderer.directive";

@Component({
  selector: "slms-table-box",
  imports: [
    //--- NG Modules
    NgClass,
    FormsModule,
  ...
  styleUrl: "./table-box.component.less",
})
export class TableBoxComponent implements AfterViewInit {
  //--- ViewChild
  @ViewChild("tableBoxConfigModal") public readonly tableBoxConfigModal: AnswerBoxConfigModalComponent;
  ...
  //--- Forms
  public tableTitleFormControl = new FormControl<string>("");
  public questionsFormArray: FormArray = new FormArray([]);
  public answerChoicesFormArray: FormArray = new FormArray([]);
  ...
  public addQuestion(): void {
    this.tableBoxConfigModal.setToEdit("questions");
    this.tableBoxConfigModal.toggle();
  }

  /**
   * @name          addAnswerChoice
   * @description   Add answer choice in table
   * @returns       {void}
   */
  public addAnswerChoice(): void {
    this.tableBoxConfigModal.setToEdit("answer-options");
    this.tableBoxConfigModal.toggle();
  }
