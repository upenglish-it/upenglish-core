  ...
  "node_modules/react/cjs/react-jsx-runtime.development.js"(exports2) {
    ...
    (function() {
      ...
      function hasValidKey(config4) {
        if (hasOwnProperty27.call(config4, "key")) {
      ...
      function jsxDEVImpl(type, config4, maybeKey, isStaticChildren, debugStack, debugTask) {
        ...
        if (hasOwnProperty27.call(config4, "key")) {
          ...
          var keys2 = Object.keys(config4).filter(function(k) {
            return "key" !== k;
          });
        ...
        hasValidKey(config4) && (checkKeyStringCoercion(config4.key), children = "" + config4.key);
        if ("key" in config4) {
          maybeKey = {};
